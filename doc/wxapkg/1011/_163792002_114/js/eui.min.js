...
!function(t) {
    t.getAssets = function(i, n, o) {
        var r = e.getImplementation("eui.IAssetAdapter");
        r || (r = new t.DefaultAssetAdapter()), r.getAsset(i, function(t) {
            n.call(o, t);
        }, this);
            ...
            return i.prototype.$parseCode = function(t, i) {
                ...
                for (var y, v = this.currentXML, g = (this.getClassNameOfNode(v), v.attributes), m = Object.keys(g), $ = m.length, E = 0; $ > E; E++) {
                    ...
                    if (-1 != S) {
                        ...
                        var P = this.formatValue(T, b, v);
                        if (!P) continue;
                        var I = C.substr(S + 1), x = (y = this.getStateByName(I, v)).length;
                        if (x > 0) for (r = 0; x > r; r++) (_ = y[r]).addOverride(new t.EXSetProperty("", T, P));
                    }
                }
                        ...
                        if (this.isStateNode(r)) {
                            ...
                            if (d.includeIn) C = d.includeIn.split(","); else {
                                for (var b = d.excludeFrom.split(","), S = b.length, T = 0; S > T; T++) {
                                    var P = b[T];
                                    this.getStateByName(P, r);
                                }
                                S = this.stateCode.length;
                                for (T = 0; S > T; T++) g = this.stateCode[T], -1 == b.indexOf(g.name) && C.push(g.name);
                            }
                            for (var I = C.length, x = 0; I > x; x++) if (y = C[x], (v = this.getStateByName(y, r)).length > 0) for (var L = v.length, T = 0; L > T; T++) (g = v[T]).addOverride(new t.EXAddItems(f, m, E.position, E.relativeTo));
                        }
    ...
    var o = function(i) {
        ...
        return n(o, i), Object.defineProperty(o.prototype, "scale9Grid", {
            ...
            i && "string" == typeof i ? t.getAssets(this._source, function(t) {
                i === this._source && e.is(t, "egret.Texture") && (this.$setTexture(t), t && this.dispatchEventWith(e.Event.COMPLETE));
            }, this) : this.$setTexture(i);
...
!function(t) {
    var o = function(i) {
        ...
        return n(o, i), Object.defineProperty(o.prototype, "data", {
            ...
            this.$stage && (this.$stage.addEventListener(e.TouchEvent.TOUCH_CANCEL, this.onTouchCancle, this), 
            this.$stage.addEventListener(e.TouchEvent.TOUCH_END, this.onStageTouchEnd, this), 
            this.touchCaptured = !0, this.invalidateState(), t.updateAfterEvent());
...
!function(t) {
    var o, r = function(i) {
        ...
        return n(r, i), Object.defineProperty(r.prototype, "bounces", {
            ...
            this.$stage && (this.$Scroller[12] = !1, this.checkScrollPolicy() && this.onTouchBegin(t));
            ...
            var i = this.$Scroller[10];
            i && (i.scrollH = t), this.dispatchEventWith(e.Event.CHANGE);
        }, r.prototype.verticalUpdateHandler = function(t) {
            var i = this.$Scroller[10];
            i && (i.scrollV = t), this.dispatchEventWith(e.Event.CHANGE);
...
!function(t) {
    var o = t.sys.UIComponentImpl, r = function(i) {
        ...
        return n(r, i), r.prototype.$invalidateTextField = function() {
            ...
            i.prototype.$onRemoveFromStage.call(this), this.removeEventListener(e.FocusEvent.FOCUS_IN, this.onfocusIn, this), 
            ...
            if (t) {
                for (var s = t.numChildren, a = 0, h = 0, l = e.$TempRectangle, u = 0; s > u; u++) {
                    ...
                    if (e.is(p, n) && p.$includeInLayout) {
                        ...
                        var S = l.width, T = l.height, P = NaN, I = NaN;
                        P = isNaN(d) ? isNaN(y) ? isNaN(v) ? l.x : o - S - v : y : Math.round((o - S) / 2 + d), 
                        I = isNaN(f) ? isNaN(g) ? isNaN(m) ? l.y : r - T - m : g : Math.round((r - T) / 2 + f), 
                        p.setLayoutBoundsPosition(P, I), a = Math.max(a, P + S), h = Math.max(h, I + T);
                    }
                }
...
!function(t) {
    var o = "eui.UIComponent", r = function(i) {
        ...
        return n(r, i), r.prototype.measureReal = function() {
            ...
            var v, g, m, $ = r.numElements, E = $, C = s, b = h, S = 0, T = 0, P = [], I = p, x = this.maxElementSize, L = e.$TempRectangle;
            for (v = 0; $ > v; v++) {
                var N = r.getElementAt(v);
                if (e.is(N, o) && N.$includeInLayout) if (N.getPreferredBounds(L), x = Math.max(x, L.height), 
                d) S += L.width; else {
                    X = N.$UIComponent;
                    isNaN(X[6]) ? I -= L.width : (T += X[6], m = new t.sys.ChildInfo(), m.layoutElement = N, 
                    m.percent = X[6], m.min = X[12], m.max = X[13], P.push(m));
                } else E--;
            }
            I = (I -= u * (E - 1)) > 0 ? I : 0;
            ...
            if (d) {
                if (0 > O) {
                    for (_ = I / E, v = 0; $ > v; v++) g = r.getElementAt(v), e.is(g, o) && g.$includeInLayout && (g.getPreferredBounds(L), 
                    L.width <= _ && (I -= L.width, A--));
                    I = I > 0 ? I : 0;
                }
            } else if (T > 0) {
                this.flexChildrenProportionally(p, I, T, P);
                var D = 0, R = P.length;
                for (v = 0; R > v; v++) {
                    m = P[v];
                    var M = Math.round(m.size + D);
                    D += m.size - M, B[m.layoutElement.$hashCode] = M, I -= M;
                }
                I = I > 0 ? I : 0;
            }
            this.$horizontalAlign == e.HorizontalAlign.CENTER ? C = s + .5 * I : this.$horizontalAlign == e.HorizontalAlign.RIGHT && (C = s + I);
            ...
            for (v = 0; $ > v; v++) {
                ...
                if (g = r.getElementAt(v), e.is(g, o) && g.$includeInLayout) {
                    if (g.getPreferredBounds(L), k = NaN, d ? (F = NaN, O > 0 ? F = I * L.width / S : 0 > O && L.width > _ && (F = I / A), 
            ...
            for (var P = 0, I = 0, x = 0, L = !1, N = this.elementSizeTable, _ = this.startIndex; c >= _; _++) {
                var O = 0;
                v = r.getVirtualElementAt(_), e.is(v, o) && v.$includeInLayout && (v.getPreferredBounds(g), 
                f || (b = Math.max(b, g.height)), d ? (I = h, v.setLayoutBoundsSize(NaN, $), v.getLayoutBounds(g)) : (v.getLayoutBounds(g), 
                O = (m - g.height) * y, O = O > 0 ? O : 0, I = h + O), x = Math.max(x, g.height), 
                L || (isNaN(N[_]) ? C : N[_]) != g.width && (L = !0), N[_] = g.width, P = this.getStartPosition(_), 
                v.setLayoutBoundsPosition(Math.round(P), Math.round(I)));
            }
    ...
    var o = "eui.UIComponent", r = function(i) {
        ...
        return n(r, i), Object.defineProperty(r.prototype, "horizontalGap", {
            ...
            if (i.prototype.updateDisplayList.call(this, n, r), this.$target) {
                ...
                var I = a + h, x = l + u, L = (S + $) * b - $, N = (T + E) * C - E;
                s.setContentSize(L + I, N + x);
            }
...
!function(t) {
    var o = "eui.UIComponent", r = function(i) {
        ...
        return n(r, i), r.prototype.measureReal = function() {
            ...
            var v, g, m, $ = r.numElements, E = $, C = s, b = h, S = 0, T = 0, P = [], I = c, x = this.maxElementSize, L = e.$TempRectangle;
            for (v = 0; $ > v; v++) {
                var N = r.getElementAt(v);
                if (e.is(N, o) && N.$includeInLayout) if (N.getPreferredBounds(L), x = Math.max(x, L.width), 
                d) S += L.height; else {
                    X = N.$UIComponent;
                    isNaN(X[7]) ? I -= L.height : (T += X[7], m = new t.sys.ChildInfo(), m.layoutElement = N, 
                    m.percent = X[7], m.min = X[14], m.max = X[15], P.push(m));
                } else E--;
            }
            I = (I -= u * (E - 1)) > 0 ? I : 0;
            ...
            if (d) {
                if (0 > O) {
                    for (_ = I / E, v = 0; $ > v; v++) g = r.getElementAt(v), e.is(g, o) && g.$includeInLayout && (g.getPreferredBounds(L), 
                    L.height <= _ && (I -= L.height, A--));
                    I = I > 0 ? I : 0;
                }
            } else if (T > 0) {
                this.flexChildrenProportionally(c, I, T, P);
                var D = 0, R = P.length;
                for (v = 0; R > v; v++) {
                    m = P[v];
                    var M = Math.round(m.size + D);
            ...
            this.$verticalAlign == e.VerticalAlign.MIDDLE ? b = h + .5 * I : this.$verticalAlign == e.VerticalAlign.BOTTOM && (b = h + I);
            ...
            for (v = 0; $ > v; v++) {
                var j = 0;
                if (g = r.getElementAt(v), e.is(g, o) && g.$includeInLayout) {
                    if (g.getPreferredBounds(L), k = NaN, d ? (F = NaN, O > 0 ? F = I * L.height / S : 0 > O && L.height > _ && (F = I / A), 
            ...
            for (var P = 0, I = 0, x = 0, L = !1, N = this.elementSizeTable, _ = this.startIndex; c >= _; _++) {
                var O = 0;
                v = r.getVirtualElementAt(_), e.is(v, o) && v.$includeInLayout && (v.getPreferredBounds(g), 
                f || (b = Math.max(b, g.width)), d ? (P = h, v.setLayoutBoundsSize($, NaN), v.getLayoutBounds(g)) : (v.getLayoutBounds(g), 
                O = (m - g.width) * y, O = O > 0 ? O : 0, P = h + O), x = Math.max(x, g.width), 
                L || (isNaN(N[_]) ? E : N[_]) != g.height && (L = !0), N[_] = g.height, I = this.getStartPosition(_), 
                v.setLayoutBoundsPosition(Math.round(P), Math.round(I)));
            }
...
}(r || (r = {})), window.eui = r, window.EXML = o;