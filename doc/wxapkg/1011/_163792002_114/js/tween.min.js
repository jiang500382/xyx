    ...
    var i = function(t) {
        ...
        return e(i, t), i.get = function(t, e, n, s) {
            ...
            if (this.position = this._prevPos = n, this._prevPosition = t, this._target && this._steps.length > 0) {
                for (var r = this._steps.length, u = -1, p = 0; r > p && !("step" == this._steps[p].type && (u = p, 
                this._steps[p].t <= n && this._steps[p].t + this._steps[p].d >= n)); p++) ;
                for (p = 0; r > p; p++) if ("action" == this._steps[p].type) 0 != e && (this._useTicks ? this._runAction(this._steps[p], n, n) : 1 == e && o > n ? (o != this.duration && this._runAction(this._steps[p], o, this.duration), 
            ...
            e > n && (s = n, o = e);
            var r = t.t;
            (r == o || r > s && o > r || i && r == e) && t.f.apply(t.o, t.p);
            ...
            for (var a in this._initQueueProps) {
                ...
                var h = !1;
                if (p = i._plugins[a]) for (var c = 0, f = p.length; f > c; c++) {
            ...
            for (var u in t) if (void 0 === this._initQueueProps[u]) {
                if (n = this._target[u], e = i._plugins[u]) for (s = 0, o = e.length; o > s; s++) n = e[s].init(this, u, n);
                this._initQueueProps[u] = this._curQueueProps[u] = void 0 === n ? null : n;
            } else n = this._curQueueProps[u];
            for (var u in t) {
                if (n = this._curQueueProps[u], e = i._plugins[u]) for (r = r || {}, s = 0, o = e.length; o > s; s++) e[s].step && e[s].step(this, u, n, t[u], r);
