...
!function(t) {
    ...
    var n = function(e) {
        ...
        return i(n, e), n.prototype.createNativeDisplayObject = function() {
            ...
            var i = this;
            if (i.$scaleX != e) if (i.$scaleX = e, i.$matrixDirty = !0, i.$updateUseTransform(), 
            t.nativeRender) i.$nativeDisplayObject.setScaleX(e); else {
                var r = i.$parent;
                r && !r.$cacheDirty && (r.$cacheDirty = !0, r.$cacheDirtyUp());
                var n = i.$maskedObject;
                n && !n.$cacheDirty && (n.$cacheDirty = !0, n.$cacheDirtyUp());
            ...
            var i = this;
            if (i.$scaleY != e) if (i.$scaleY = e, i.$matrixDirty = !0, i.$updateUseTransform(), 
            t.nativeRender) i.$nativeDisplayObject.setScaleY(e); else {
                var r = i.$parent;
                r && !r.$cacheDirty && (r.$cacheDirty = !0, r.$cacheDirtyUp());
                var n = i.$maskedObject;
                n && !n.$cacheDirty && (n.$cacheDirty = !0, n.$cacheDirtyUp());
            ...
            var i = this;
            if (e || i.$scrollRect) {
                if (e ? (i.$scrollRect || (i.$scrollRect = new t.Rectangle()), i.$scrollRect.copyFrom(e), 
                t.nativeRender && i.$nativeDisplayObject.setScrollRect(e.x, e.y, e.width, e.height)) : (i.$scrollRect = null, 
                t.nativeRender && i.$nativeDisplayObject.setScrollRect(0, 0, 0, 0)), !t.nativeRender) {
                    i.$updateRenderMode();
                    var r = i.$parent;
                    r && !r.$cacheDirty && (r.$cacheDirty = !0, r.$cacheDirtyUp());
                    var n = i.$maskedObject;
        ...
        }, n.prototype.$updateRenderNode = function() {}, n.prototype.$hitTest = function(e, i) {
            var r = this;
            ...
            var a = r.$getContentBounds(), o = n.a * e + n.c * i + n.tx, s = n.b * e + n.d * i + n.ty;
            if (a.contains(o, s)) {
                if (!r.$children) {
...
!function(t) {
    var r = function(t) {
        ...
        return i(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            var n;
            if (t.hasOwnProperty("eventPool") && (n = t.eventPool), n || (n = t.eventPool = []), 
            n.length) {
                var a = n.pop();
...
!function(t) {
    var r = function(e) {
        ...
        return i(r, e), Object.defineProperty(r.prototype, "numChildren", {
            ...
            o && o.removeChild(e), a.$children.splice(i, 0, e), e.$setParent(a), t.nativeRender && a.$nativeDisplayObject.addChildAt(e.$nativeDisplayObject.id, i);
            var s = a.$stage;
            ...
            if (!t.nativeRender && (e.$maskedObject && e.$maskedObject.$updateRenderMode(), 
            !a.$cacheDirty)) {
                a.$cacheDirty = !0;
                var l = a.$parent;
...
!function(t) {
    var r = function(e) {
        ...
        return i(r, e), r.prototype.createNativeDisplayObject = function() {
            ...
            set: function(e) {
                var i = this;
                if (e != this.$smoothing && (this.$smoothing = e, this.$renderNode.smoothing = e, 
                !t.nativeRender)) {
                    var r = i.$parent;
                    r && !r.$cacheDirty && (r.$cacheDirty = !0, r.$cacheDirtyUp());
                    var n = i.$maskedObject;
...
!function(t) {
    ...
    e[1051] = "runtime only support webgl render mode", e[3e3] = "Theme configuration file failed to load: {0}", 
    e[3001] = "Cannot find the skin name which is configured in Theme: {0}", e[3002] = 'Index:"{0}" is out of the collection element index range', 
...
!function(t) {
    ...
    e[1051] = "runtime 只支持 webgl 渲染模式", e[3e3] = "主题配置文件加载失败: {0}", e[3001] = "找不到主题中所配置的皮肤类名: {0}", 
    e[3002] = '索引:"{0}"超出集合元素索引范围', e[3003] = "在此组件中不可用，若此组件为容器类，请使用", e[3004] = "addChild(){0}addElement()代替", 
    e[3005] = "addChildAt(){0}addElementAt()代替", e[3006] = "removeChild(){0}removeElement()代替", 
    e[3007] = "removeChildAt(){0}removeElementAt()代替", e[3008] = "setChildIndex(){0}setElementIndex()代替", 
    e[3009] = "swapChildren(){0}swapElements()代替", e[3010] = "swapChildrenAt(){0}swapElementsAt()代替", 
    e[3011] = '索引:"{0}"超出可视元素索引范围', e[3012] = "此方法在Scroller组件内不可用!", e[3013] = "UIStage是GUI根容器，只能有一个此实例在显示列表中！", 
    e[3014] = "设置全屏模式失败", e[3100] = "当前浏览器不支持WebSocket", e[3101] = "请先连接WebSocket", 
    e[3102] = "请先设置type为二进制类型", e[4e3] = "An Bone cannot be added as a child to itself or one of its children (or children's children, etc.)", 
    e[4001] = "Abstract class can not be instantiated!", e[4002] = "Unnamed data!", 
    e[4003] = "Nonsupport version!";
}(p || (p = {}));
    ...
    !function(r) {
        var n = function(e) {
            ...
            return i(r, e), r.prototype.drawImage = function(t, e, i, r, n, a, o, s) {
                ...
                var w = n, E = w + x, R = E + D, S = g - x - D, F = a, P = F + T, C = P + O, _ = v - T - O, M = S * t.$TextureScaleFactor, j = _ * t.$TextureScaleFactor;
                if ((x + S) * t.$TextureScaleFactor > p || (T + _) * t.$TextureScaleFactor > d) e.drawImage(n, a, o, s, h, c, p, d); else {
                    var N = h, A = N + b, B = N + (p - M), k = p - b - M, L = c, I = L + m, U = L + d - j, X = d - m - j;
                    T > 0 && (x > 0 && e.drawImage(w, F, x, T, N, L, b, m), D > 0 && e.drawImage(E, F, D, T, A, L, k, m), 
                    S > 0 && e.drawImage(R, F, S, T, B, L, M, m)), O > 0 && (x > 0 && e.drawImage(w, P, x, O, N, I, b, X), 
                    D > 0 && e.drawImage(E, P, D, O, A, I, k, X), S > 0 && e.drawImage(R, P, S, O, B, I, M, X)), 
                    _ > 0 && (x > 0 && e.drawImage(w, C, x, _, N, U, b, j), D > 0 && e.drawImage(E, C, D, _, A, U, k, j), 
                    S > 0 && e.drawImage(R, C, S, _, B, U, M, j));
                }
...
!function(i) {
    ...
    function s(t, e, i, r) {
        for (var n = r[0], a = r[1], o = r[2], s = r[3], h = r[4], c = r[5], l = r[6], u = r[7], p = r[8], d = r[9], f = r[10], $ = r[11], y = r[12], g = r[13], v = r[14], b = r[15], m = r[16], x = r[17], T = r[18], D = r[19], O = 0, w = e * i * 4; w > O; O += 4) {
            var E = t[O + 0], R = t[O + 1], S = t[O + 2], F = t[O + 3];
            t[O + 0] = n * E + a * R + o * S + s * F + h, t[O + 1] = c * E + l * R + u * S + p * F + d, 
            t[O + 2] = f * E + $ * R + y * S + g * F + v, t[O + 3] = b * E + m * R + x * S + T * F + D;
        }
    }
    ...
    function g(t, e, i, r, n, a, s, h, c, l, u, p) {
        ...
        for (var f, $, g = r[3], v = 0, b = 0, m = h * Math.cos(s), x = h * Math.sin(s), T = 3.141592653589793, D = n / 7, O = a / 7, E = 0; e > E; E++) for (var R = 0; i > R; R++) {
            for (var S = R * e * 4 + 4 * E, F = 0, P = 0, C = t[S + 0] / 255, _ = t[S + 1] / 255, M = t[S + 2] / 255, j = t[S + 3] / 255, N = 0; 2 * T >= N; N += 2 * T / 12) {
                f = Math.cos(N + 0), $ = Math.sin(N + 0);
                for (var A = 0; 7 > A; A++) {
                    v = A * D * f, b = A * O * $;
                    var B = Math.round(E + v - m), k = Math.round(R + b - x);
                    F += (7 - A) * (B >= e || 0 > B || 0 > k || k >= i ? 0 : t[k * e * 4 + 4 * B + 3] / 255), 
                    P += 7 - A;
                }
            }
            j = Math.max(j, 1e-4);
            var L = F / P * c * g * (1 - l) * Math.max(Math.min(p, u), 1 - j), I = (P - F) / P * c * g * l * j, U = I / (I + (j = Math.max(j * u * (1 - p), 1e-4))), X = y(C, r[0], U), H = y(_, r[1], U), Y = y(M, r[2], U), W = L / (I + j + L), G = y(X, r[0], W), z = y(H, r[1], W), V = y(Y, r[2], W), q = Math.min(j + L + I, 1);
            d[S + 0] = 255 * G, d[S + 1] = 255 * z, d[S + 2] = 255 * V, d[S + 3] = 255 * q;
        }
        w ? t.set(d) : o(t, d);
    }
        ...
        return t.prototype.render = function(t, e, r, n) {
            ...
            if (c) {
                ...
                if ((!c.$children || 0 == c.$children.length) && x && 3 == x.type && 1 == x.drawData.length && 1 == x.drawData[0].type && 1 == x.drawData[0].fillAlpha) {
                    ...
                    c.$getConcatenatedMatrixAt(t, D), D.prepend(1, 0, 0, 1, r, n), e.transform(D.a, D.b, D.c, D.d, D.tx, D.ty);
                    var u = this.drawDisplayObject(c, e, 0, 0);
            ...
            var p = t.$getOriginalBounds(), d = p.x, f = p.y, $ = p.width, y = p.height;
            if (0 >= $ || 0 >= y) return o;
            var g = this.createRenderBuffer($, y), m = g.context;
            ...
            if ($ && 8 == o) {
                ...
                var R = this.createRenderBuffer(w, E), S = R.context;
                f++, t.rotated && e.transform(0, -1, 1, 0, 0, w), S.drawImage(i.source, y, g, m, x, 0, 0, w, E), 
                f++;
                var F = S.getImageData(0, 0, w, E);
                s(F.data, w, E, $.$matrix), S.putImageData(F, 0, 0), e.drawImage(R.surface, 0, 0, w, E, D + e.$offsetX, O + e.$offsetY, w, E), 
                T.push(R);
...
!function(t) {
    ...
    var i = function() {
        ...
        e.engineVersion = "5.2.10", e.renderMode = "Unknown", e.boundingClientWidth = 0, 
...
!function(t) {
    var r = function(e) {
        ...
        return i(r, e), r.prototype.createNativeDisplayObject = function() {
            ...
            if (0 != n) {
                ...
                for (var c = h._getFirstCharHeight(), l = Math.ceil(c * r.EMPTY_FACTOR), u = !isNaN(e.$textFieldHeight), p = e.$textWidth, d = e.$textFieldWidth, f = e.$textFieldHeight, $ = e.$textAlign, y = this.$textOffsetY + this.$textStartY, g = this.$lineHeights, v = 0; n > v; v++) {
                    ...
                    for (var O = 0; x > O; O++) {
                        ...
                        if (E) {
                            var R = E.$bitmapWidth, S = E.$bitmapHeight;
                            t.nativeRender ? o.push(E.$bitmapX, E.$bitmapY, R, S, T + E.$offsetX, y + E.$offsetY, E.$getScaleBitmapWidth(), E.$getScaleBitmapHeight(), E.$sourceWidth, E.$sourceHeight) : (a.imageWidth = E.$sourceWidth, 
                            a.imageHeight = E.$sourceHeight, a.drawImage(E.$bitmapX, E.$bitmapY, R, S, T + E.$offsetX, y + E.$offsetY, E.$getScaleBitmapWidth(), E.$getScaleBitmapHeight())), 
            ...
            } else t.nativeRender && e.$font && (e.$nativeDisplayObject.setDataToBitmapNode(e.$nativeDisplayObject.id, e.$font.$texture, []), 
            ...
            for (var s, h, c, l, u = i.$lineSpacing, p = i.$letterSpacing, d = 0, f = 0, $ = 0, y = 0, g = !isNaN(i.$textFieldWidth), v = i.$textFieldWidth, b = i.$textFieldHeight, m = i.$font, x = m._getFirstCharHeight(), T = Math.ceil(x * r.EMPTY_FACTOR), D = i.$text.split(/(?:\r\n|\r|\n)/), O = D.length, w = !0, E = 0; O > E; E++) {
                var R = D[E], S = R.length;
                c = 0, l = 0, s = !0, h = !1;
                for (var F = 0; S > F; F++) {
                    s || (l += p);
                    var P = R.charAt(F), C = void 0, _ = void 0, M = 0, j = 0, N = m.getTexture(P);
                    if (N) C = N.$getTextureWidth(), _ = N.$getTextureHeight(), M = N.$offsetX, j = N.$offsetY; else {
                        if (" " != P) {
                            t.$warn(1046, P), s && (s = !1);
                            continue;
                        }
                    ...
                    if (s && (s = !1, $ = Math.min(M, $)), w && (w = !1, y = Math.min(j, y)), g && F > 0 && l + C > v) {
                        if (!e(R.substring(0, F))) break;
                        S = (R = R.substring(F)).length, l = (F = 0) == S - 1 ? C : m.getConfig(P, "xadvance") || C, 
                        c = _;
                    } else l += F == S - 1 ? C : m.getConfig(P, "xadvance") || C, c = Math.max(_, c);
                }
                if (b && E > 0 && f > b) break;
                if (h = !0, !e(R)) break;
            }
...
!function(t) {
    ...
    var n = new RegExp("(?=[\\u00BF-\\u1FFF\\u2C00-\\uD7FF]|\\b|\\s)(?![。，！、》…）)}”】\\.\\,\\!\\?\\]\\:])"), a = function(e) {
        ...
        return i(a, e), a.prototype.createNativeDisplayObject = function() {
            ...
            set: function(e) {
                (e = Math.max(e, 1)) != this.$TextField[28] && (this.$TextField[28] = e, t.nativeRender && this.$nativeDisplayObject.setScrollV(e), 
            ...
            return this.$TextField[30] != e && (this.$TextField[30] = e, this.$invalidateTextField(), 
            t.nativeRender && this.$nativeDisplayObject.setMultiline(e), !0);
            ...
            e = !!e, this.$TextField[31] != e && (this.$TextField[31] = e, this.$invalidateTextField(), 
            t.nativeRender && this.$nativeDisplayObject.setBorder(e));
            ...
            e = +e || 0, this.$TextField[32] != e && (this.$TextField[32] = e, this.$invalidateTextField(), 
            t.nativeRender && this.$nativeDisplayObject.setBorderColor(e));
            ...
            this.$TextField[33] != e && (this.$TextField[33] = e, this.$invalidateTextField(), 
            t.nativeRender && this.$nativeDisplayObject.setBackground(e));
            ...
            this.$TextField[34] != e && (this.$TextField[34] = e, this.$invalidateTextField(), 
            t.nativeRender && this.$nativeDisplayObject.setBackgroundColor(e));
                        ...
                        if ("" == $[y]) y == g - 1 && (v = !1); else {
                            ...
                            if (isNaN(a)) h += b, c += $[y].length, o.elements.push({
                                ...
                                for (var m = 0, x = 0, T = $[y], D = void 0, O = (D = e[19] ? T.split(n) : T.match(/./g)).length, w = 0; O > m; m++) {
                                    var E = D[m].length, R = !1;
                                    if (1 == E && O - 1 > m) {
                                        var S = D[m].charCodeAt(0), F = D[m + 1].charCodeAt(0);
                                        S >= 55296 && 56319 >= S && 56320 == (64512 & F) ? (E = 2, R = !0, b = r(j = D[m] + D[m + 1], e, f.style)) : b = r(D[m], e, f.style);
                                    } else b = r(D[m], e, f.style);
                                    if (0 != h && h + b > a && h + m != 0) break;
                                    if (x + b > a) for (var P = D[m].match(/./g), C = 0, _ = P.length; _ > C; C++) {
                                        var M = !1;
                                        if (1 == (E = P[C].length) && _ - 1 > C) {
                                            var S = P[C].charCodeAt(0), F = P[C + 1].charCodeAt(0);
                                            if (S >= 55296 && 56319 >= S && 56320 == (64512 & F)) {
                                                var j = P[C] + P[C + 1];
                                                E = 2, M = !0, b = r(j, e, f.style);
                                ...
                                if (m > 0) {
                                    ...
                                    var N = T.substring(w), A = void 0, B = N.length;
                                    for (A = 0; B > A && " " == N.charAt(A); A++) ;
                                    $[y] = N.substring(A);
                                }
                                "" != $[y] && (y--, v = !1);
                            }
