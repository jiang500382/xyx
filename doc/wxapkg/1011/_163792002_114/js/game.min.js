...
!function(i) {
    var r = function(t) {
        ...
        return e(r, t), r.prototype.$init = function(t, e, i) {
            ...
            for (var e, i = this.frames, r = t ? t.length : 0, o = 0; r > o; o++) {
                var n = t[o];
                if (i.push(n), n.duration) {
                    var s = parseInt(n.duration);
                    if (s > 1) {
                        e = i.length;
                        for (var a = 1; s > a; a++) i.push({
                            frame: e
                        });
                    }
                }
    ...
    var o = function(t) {
        ...
        return e(r, t), r.get = function(t, e, i, o) {
            ...
            if (this.position = this._prevPos = i, this._prevPosition = t, this._target) if (r) this._updateTargetProps(null, 1); else if (this._steps.length > 0) {
                ...
                for (n = 0; s > n && !(this._steps[n].t > i); n++) ;
                var a = this._steps[n - 1];
                this._updateTargetProps(a, (this._stepPosition = i - a.t) / a.d);
            }
            return r && this.setPaused(!0), 0 != e && this._actions.length > 0 && (this._useTicks ? this._runActions(i, i) : 1 == e && o > i ? (o != this.duration && this._runActions(o, this.duration), 
            ...
            for (t > e && (r = e, o = t, n = s, s = a = -1); (n += a) != s; ) {
                ...
                (h == o || h > r && o > h || i && h == t) && c.f.apply(c.o, c.p);
            }
            ...
            for (var h in this._initQueueProps) {
                ...
                var l = !1;
                if (c = r._plugins[h]) for (var u = 0, p = c.length; p > u; u++) {
        ...
        return e(r, t), Object.defineProperty(r.prototype, "bounces", {
            ...
            if (void 0 === i && (i = !1), (!i || 0 != t || 0 != e) && (i || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
                ...
                if (i) {
                    ...
                    (0 >= r || r >= s) && (t /= 2), (0 >= o || o >= n) && (e /= 2);
                    var a = r + t, c = o + e;
                    this._ScrV_Props_._bounces || ((0 >= a || a >= s) && (a = Math.max(0, Math.min(a, s))), 
                    (0 >= c || c >= n) && (c = Math.max(0, Math.min(c, n)))), this._ScrV_Props_._scrollTop = a, 
            ...
            for (var e = t.$target, r = this.$getPropagationList(e), o = r.length, n = .5 * r.length, s = -1, a = 0; o > a; a++) if (r[a] === this._content) {
                s = a;
                break;
            }
            ...
            if (0 > n || n > i) for (n = e; Math.abs(t) != 1 / 0 && Math.abs(t) > .02; ) t *= 0 > (n += t) || n > i ? .998 * .95 : .998, 
    ...
    var o = function(t) {
        ...
        return e(o, t), o.prototype.load = function(t) {
            ...
            if (e.dataFormat != i.URLLoaderDataFormat.TEXTURE) if (e.dataFormat != i.URLLoaderDataFormat.SOUND) {
                ...
                s = t.data));
                for (var a = t.requestHeaders.length, c = 0; a > c; c++) {
...
!function(i) {
    var r = function(t) {
        ...
        return e(r, t), r.prototype.createNativeDisplayObject = function() {
            ...
            1 > e ? e = 1 : e > this.$totalFrames && (e = this.$totalFrames), e != this.$nextFrameNum && (this.$nextFrameNum = e, 
            ...
            if (0 != this.$eventPool.length) {
                ...
                for (var t = this.$eventPool, e = t.length, r = !1, o = !1, n = 0; e > n; n++) {
                    var s = t.pop();
...
!function(i) {
    var r = function(t) {
        function r() {
            ...
            r.instance, i.ticker.$startTick(e.update, e), e._lastTime = i.getTimer(), e;
        }
...
!function(i) {
    var r = function(t) {
        function r(e) {
            void 0 === e && (e = 300);
            var i = t.call(this) || this;
            return i.objectPool = [], i._length = 0, 1 > e && (e = 1), i.autoDisposeTime = e, 
            i.frameCount = 0, i;
        }
