    ...
    !function(i) {
        var a = new r.TextField(), n = function(e) {
            function i(t, r, i, n, o) {
                ...
                s.arrFps = [], s.arrCost = [], a.x = void 0 == o.x ? 0 : parseInt(o.x), a.y = void 0 == o.y ? 0 : parseInt(o.y), 
                a.textColor = void 0 == o.textColor ? "#ffffff" : o.textColor.replace("0x", "#");
                var c = void 0 == o.size ? 12 : parseInt(o.size);
                return a.size = c, s;
            }
            ...
            i.prototype.update = function(e, t) {
                void 0 === t && (t = !1);
                var i, n, o;
                t ? (i = this.arrFps[this.arrFps.length - 1], n = this.arrCost[this.arrCost.length - 1][0], 
                ...
                for (var u = this.arrFps[0], h = this.arrFps[0], d = 0; d < c; d++) {
                    var l = this.arrFps[d];
                    s += l, l < u ? u = l : l > h && (h = l);
                }
...
function(e) {
    ...
    !function(t) {
        ...
        e.sys.measureText = function(e, t, a, n, o) {
            ...
            i.font = s, i && i.measureText(e) ? i.measureText(e).width : 0;
        };
    }(e.wxgame || (e.wxgame = {}));
    ...
    !function(e) {
        e.version = "1.1.8", e.isSubContext = !1, e.preUploadTexture = !1;
    }(e.wxgame || (e.wxgame = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
        function r(r) {
        ...
        e.runEgret = function(s) {
            if (!n) {
                ...
                var u;
                if (s.canvasScaleFactor) u = s.canvasScaleFactor; else if (s.calculateCanvasScaleFactor) u = s.calculateCanvasScaleFactor(e.sys.canvasHitTestBuffer.context); else {
                    var h = e.sys.canvasHitTestBuffer.context, d = h.backingStorePixelRatio || h.webkitBackingStorePixelRatio || h.mozBackingStorePixelRatio || h.msBackingStorePixelRatio || h.oBackingStorePixelRatio || h.backingStorePixelRatio || 1;
                    u = (window.devicePixelRatio || 1) / d;
                }
                e.sys.DisplayList.$canvasScaleFactor = u, i(e.ticker), s.screenAdapter ? e.sys.screenAdapter = s.screenAdapter : e.sys.screenAdapter || (e.sys.screenAdapter = new e.sys.DefaultScreenAdapter());
                var l = {}, f = new t.WebPlayer(l, s);
...
function(t) {
    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(a, e), a.prototype.init = function(e, t) {
                ...
                var c = new i.WebTouchHandler(n, s), u = new r.sys.Player(o, n, a.entryClassName);
                r.lifecycle.stage = n, r.lifecycle.addLifecycleListener(i.WebLifeCycleHandler), 
                (a.showFPS || a.showLog) && u.displayFPS(a.showFPS, a.showLog, a.logFilter, a.fpsStyles), 
                this.playerOption = a, this.container = e, this.canvas = s, this.stage = n, this.player = u, 
                this.webTouchHandler = c, this.updateScreenSize(), this.updateMaxTouches(), u.start();
                ...
                for (var a = (t.fpsStyles || "x:0,y:0,size:12,textColor:0xffffff,bgAlpha:0.9").split(","), n = {}, o = 0; o < a.length; o++) {
                    var s = a[o].split(":");
                    n[s[0]] = s[1];
                }
                ...
                if (!e.userTyping) {
                    ...
                    var c = !1, u = this.stage.$orientation;
                    u != r.OrientationMode.AUTO && (c = u != r.OrientationMode.PORTRAIT && s > o || u == r.OrientationMode.PORTRAIT && o > s);
                    var h = c ? s : o, d = c ? o : s;
                    r.Capabilities.boundingClientWidth = h, r.Capabilities.boundingClientHeight = d;
                    var l = r.sys.screenAdapter.calculateStageSize(this.stage.$scaleMode, h, d, t.contentWidth, t.contentHeight), f = l.stageWidth, p = l.stageHeight, g = l.displayWidth, v = l.displayHeight;
                    ...
                    e.height = p));
                    var x = 0;
                    c ? u == r.OrientationMode.LANDSCAPE ? (x = 90, e.style.top = n + (s - g) / 2 + "px", 
    ...
    !function(t) {
        function r(t, r) {
            ...
            var s = Math.floor(r.width), c = Math.floor(r.height), u = i;
            if (u.style.width = s + "px", u.style.height = c + "px", i.width = s, i.height = c, 
            "webgl" == e.Capabilities.renderMode) {
                var h = void 0;
                t.$renderBuffer ? h = t : (h = new e.RenderTexture()).drawToTexture(new e.Bitmap(t));
                for (var d = h.$renderBuffer.getPixels(r.x, r.y, s, c), l = 0, f = 0, p = 0; p < d.length; p += 4) a.fillStyle = "rgba(" + d[p] + "," + d[p + 1] + "," + d[p + 2] + "," + d[p + 3] / 255 + ")", 
                a.fillRect(l, f, 1, 1), ++l == s && (l = 0, f++);
                return t.$renderBuffer || h.dispose(), u;
            }
        ...
        e.Texture.prototype.toDataURL = function(t, i, a) {
            ...
            if (void 0 === n && (n = 1), void 0 === o && (o = 1), "webgl" == e.Capabilities.renderMode) {
                ...
                s.$renderBuffer.getPixels(t, i, n, o);
            }
            try {
    ...
    !function(i) {
        function a(e, t) {
            ...
            for (var r = new o(e.localName, t, e.prefix, e.namespaceURI, e.nodeName), i = e.attributes, n = r.attributes, c = i.length, u = 0; u < c; u++) {
                var h = i[u], d = h.name;
                0 != d.indexOf("xmlns:") && (n[d] = h.value, r["$" + d] = h.value);
            }
            var l = e.childNodes;
            c = l.length;
            for (var f = r.children, u = 0; u < c; u++) {
                var p = l[u], g = p.nodeType, v = null;
...
function(r) {
    ...
    !function(t) {
        var r = function() {
            ...
            return e.prototype.reachMaxSize = function(e, t) {
                ...
                return this.hasMesh;
            }, e.prototype.cacheArrays = function(e, t, r, i, a, n, o, s, c, u, h, d, l, f, p) {
                ...
                if (l) {
                    var R = this.vertices, A = this.vertexIndex * this.vertSize, O = 0, _ = 0, D = 0, M = 0, B = 0, $ = 0, I = 0;
                    for (O = 0, D = d.length; O < D; O += 2) _ = A + 5 * O / 2, $ = l[O], I = l[O + 1], 
                    M = d[O], B = d[O + 1], R[_ + 0] = x * $ + y * I + b, R[_ + 1] = m * $ + w * I + T, 
                    p ? (R[_ + 2] = (t + (1 - B) * a) / u, R[_ + 3] = (r + M * i) / h) : (R[_ + 2] = (t + M * i) / u, 
                    R[_ + 3] = (r + B * a) / h), R[_ + 4] = g;
                    ...
                    if (p) {
                        var k = i;
                        i = a / G, a = k / W, R[A++] = b, R[A++] = T, R[A++] = i + t, R[A++] = r, R[A++] = g, 
                        R[A++] = x * N + b, R[A++] = m * N + T, R[A++] = i + t, R[A++] = a + r, R[A++] = g, 
                        R[A++] = x * N + y * U + b, R[A++] = w * U + m * N + T, R[A++] = t, R[A++] = a + r, 
                        R[A++] = g, R[A++] = y * U + b, R[A++] = w * U + T, R[A++] = t, R[A++] = r, R[A++] = g;
                    } else i /= G, a /= W, R[A++] = b, R[A++] = T, R[A++] = t, R[A++] = r, R[A++] = g, 
                    R[A++] = x * N + b, R[A++] = m * N + T, R[A++] = i + t, R[A++] = r, R[A++] = g, 
                    R[A++] = x * N + y * U + b, R[A++] = w * U + m * N + T, R[A++] = i + t, R[A++] = a + r, 
                    R[A++] = g, R[A++] = y * U + b, R[A++] = w * U + T, R[A++] = t, R[A++] = a + r, 
                    R[A++] = g;
                    if (this.hasMesh) {
    ...
    !function(t) {
        var r = function() {
            ...
            return e.getInstance = function(t, r) {
            ...
            }, e.prototype.drawImage = function(e, t, r, i, a, n, o, s, c, u, h, d, l) {
                ...
                if (!this.contextLost && e && f) {
                    ...
                    p && (this.drawTexture(p, t, r, i, a, n, o, s, c, u, h, void 0, void 0, void 0, void 0, d, l), 
                    e.source && e.source.texture && (f.$offsetX = g, f.$offsetY = v, f.restoreTransform()));
                }
            }, e.prototype.drawMesh = function(e, t, r, i, a, n, o, s, c, u, h, d, l, f, p, g, v) {
                ...
                if (!this.contextLost && e && x) {
                    ...
                    m && (this.drawTexture(m, t, r, i, a, n, o, s, c, u, h, d, l, f, p, g, v), (e.texture || e.source && e.source.texture) && (x.$offsetX = y, 
                    x.$offsetY = w, x.restoreTransform()));
                }
            }, e.prototype.drawTexture = function(e, t, r, i, a, n, o, s, c, u, h, d, l, f, p, g, v) {
                var x = this.currentBuffer;
                if (!this.contextLost && e && x) {
                    ...
                    this.drawCmdManager.pushDrawTexture(e, m, this.$filter), this.vao.cacheArrays(x, t, r, i, a, n, o, s, c, u, h, d, l, f, g);
                }
                ...
                if (n > 1) for (var o = 0; o < n - 1; o++) {
                    var s = e[o], c = r.rootRenderTarget.width, u = r.rootRenderTarget.height;
                    (i = t.WebGLRenderBuffer.create(c, u)).setTransform(1, 0, 0, 1, 0, 0), i.globalAlpha = 1, 
                    this.drawToRenderTarget(s, r, i), r != a && t.WebGLRenderBuffer.release(r), r = i;
                }
                var h = e[n - 1];
                this.drawToRenderTarget(h, r, this.currentBuffer), r != a && t.WebGLRenderBuffer.release(r);
                ...
                if (!this.contextLost) {
                    ...
                    if ("blur" == e.type) {
                        var c = e.blurXFilter, u = e.blurYFilter;
                        0 != c.blurX && 0 != u.blurY ? ((a = t.WebGLRenderBuffer.create(o, s)).setTransform(1, 0, 0, 1, 0, 0), 
                        a.globalAlpha = 1, this.drawToRenderTarget(e.blurXFilter, r, a), r != n && t.WebGLRenderBuffer.release(r), 
                        r = a, e = u) : e = 0 === c.blurX ? u : c;
                    }
    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(a, e), a.prototype.enableStencil = function() {
                ...
                var o = this.globalMatrix, s = o.a, c = o.b, u = o.c, h = o.d;
                1 == e && 0 == t && 0 == r && 1 == i || (o.a = e * s + t * u, o.b = e * c + t * h, 
                o.c = r * s + i * u, o.d = r * c + i * h), o.tx = a * s + n * u + o.tx, o.ty = a * c + n * h + o.ty;
    ...
    !function(r) {
        var i = [ "source-over", "lighter", "destination-out" ], a = [], n = function() {
            ...
            return e.prototype.render = function(e, r, i, n) {
                ...
                if (i.$invertInto(u), o.transform(u.a, u.b, u.c, u.d, 0, 0), t.Matrix.release(u), 
                0 === --this.nestLevel) {
                    a.length > 6 && (a.length = 6);
                    for (var h = a.length, d = 0; d < h; d++) a[d].resize(0, 0);
                }
                return c;
                ...
                if (c && !n) return s;
                var u = e.$children;
                if (u) for (var h = u.length, d = 0; d < h; d++) {
                    var l = u[d], f = void 0, p = void 0, g = void 0;
                ...
                var c, u = e.$filters, h = 0 !== e.$blendMode;
                h && ((c = i[e.$blendMode]) || (c = "source-over"));
                var d = e.$getOriginalBounds(), l = d.x, f = d.y, p = d.width, g = d.height;
                if (p <= 0 || g <= 0) return s;
                if (!e.mask && 1 == u.length && ("colorTransform" == u[0].type || "custom" === u[0].type && 0 === u[0].padding)) {
                    var v = this.getRenderCount(e);
                    if (!e.$children || 1 == v) return h && r.context.setGlobalCompositeOperation(c), 
                    r.context.$filter = u[0], e.$mask ? s += this.drawWithClip(e, r, n, o) : e.$scrollRect || e.$maskRect ? s += this.drawWithScrollRect(e, r, n, o) : s += this.drawDisplayObject(e, r, n, o), 
                    r.context.$filter = null, h && r.context.setGlobalCompositeOperation("source-over"), 
                    s;
                }
                ...
                x.context.popBuffer(), s > 0) {
                    h && r.context.setGlobalCompositeOperation(c), s++, r.$offsetX = n + l, r.$offsetY = o + f;
                    var m = t.Matrix.create(), y = r.globalMatrix;
                    m.a = y.a, m.b = y.b, m.c = y.c, m.d = y.d, m.tx = y.tx, m.ty = y.ty, r.useOffset(), 
                    r.context.drawTargetWidthFilters(u, x), y.a = m.a, y.b = m.b, y.c = m.c, y.d = m.d, 
                    y.tx = m.tx, y.ty = m.ty, t.Matrix.release(m), h && r.context.setGlobalCompositeOperation("source-over");
                }
                return a.push(x), s;
                ...
                var s, c = 0, u = 0 !== e.$blendMode;
                u && ((s = i[e.$blendMode]) || (s = "source-over"));
                var h = e.$scrollRect ? e.$scrollRect : e.$maskRect, d = e.$mask;
                if (d) {
                    var l = d.$getMatrix();
                ...
                if (d || e.$children && 0 != e.$children.length) {
                    ...
                    c > 0) {
                        c++, u && r.context.setGlobalCompositeOperation(s), h && r.context.pushMask(h.x + n, h.y + o, h.width, h.height);
                        ...
                        h && m.context.popMask(), u && r.context.setGlobalCompositeOperation("source-over");
                        var R = r.globalMatrix;
                        R.a = E.a, R.b = E.b, R.c = E.c, R.d = E.d, R.tx = E.tx, R.ty = E.ty, t.Matrix.release(E);
                    }
                    return a.push(m), c;
                }
                return h && r.context.pushMask(h.x + n, h.y + o, h.width, h.height), u && r.context.setGlobalCompositeOperation(s), 
                c += this.drawDisplayObject(e, r, n, o), u && r.context.setGlobalCompositeOperation("source-over"), 
                h && r.context.popMask(), c;
                ...
                if (t.$hasScissor || 0 != o.b || 0 != o.c) t.context.pushMask(n.x + r, n.y + i, n.width, n.height); else {
                    var u = o.a, h = o.d, d = o.tx, l = o.ty, f = n.x + r, p = n.y + i, g = f + n.width, v = p + n.height, x = void 0, m = void 0, y = void 0, w = void 0;
                    if (1 == u && 1 == h) x = f + d, m = p + l, y = g + d, w = v + l; else {
                        var b = u * f + d, T = h * p + l, E = u * g + d, C = h * p + l, S = u * g + d, L = h * v + l, R = u * f + d, A = h * v + l, O = 0;
                ...
                var a = e.image;
                if (a) {
                    var n, o, s, c = e.drawData, u = c.length, h = 0, d = e.matrix, l = e.blendMode, f = e.alpha;
                    if (d) {
                        n = t.Matrix.create();
                    ...
                    if (f == f && (g = r.globalAlpha, r.globalAlpha *= f), e.filter) {
                        for (r.context.$filter = e.filter; h < u; ) r.context.drawImage(a, c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], e.imageWidth, e.imageHeight, e.rotated, e.smoothing);
                        r.context.$filter = null;
                    } else for (;h < u; ) r.context.drawImage(a, c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], e.imageWidth, e.imageHeight, e.rotated, e.smoothing);
                    if (l && r.context.setGlobalCompositeOperation("source-over"), f == f && (r.globalAlpha = g), 
                    d) {
                ...
                var a, n, o, s = e.image, c = e.drawData, u = c.length, h = 0, d = e.matrix, l = e.blendMode, f = e.alpha;
                if (d) {
                    a = t.Matrix.create();
                    var p = r.globalMatrix;
                ...
                var g;
                if (f == f && (g = r.globalAlpha, r.globalAlpha *= f), e.filter) {
                    for (r.context.$filter = e.filter; h < u; ) r.context.drawMesh(s, c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], e.imageWidth, e.imageHeight, e.uvs, e.vertices, e.indices, e.bounds, e.rotated, e.smoothing);
                    r.context.$filter = null;
                } else for (;h < u; ) r.context.drawMesh(s, c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], c[h++], e.imageWidth, e.imageHeight, e.uvs, e.vertices, e.indices, e.bounds, e.rotated, e.smoothing);
                if (l && r.context.setGlobalCompositeOperation("source-over"), f == f && (r.globalAlpha = g), 
                d) {
                    var v = r.globalMatrix;
                ...
                if (!(a <= 0 || n <= 0) && a && n && 0 != e.drawData.length) {
                    ...
                    e.dirtyRender = !0);
                    var d = !!r.WebGLRenderContext.getInstance(0, 0).context.wxBindCanvasTexture;
                    if (d ? (this.canvasRenderer || (this.canvasRenderer = new t.CanvasRenderer()), 
                    ...
                    this.canvasRenderBuffer = new r.CanvasRenderBuffer(a, n)), this.canvasRenderBuffer.context) {
                        ...
                        u || h ? (e.dirtyRender && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, -u, -h), 
                        i.transform(1, 0, 0, 1, u / o, h / s)) : 1 == o && 1 == s || this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, 0, 0), 
                        e.dirtyRender) {
                            var l = this.canvasRenderBuffer.surface;
                            if (this.canvasRenderer.renderText(e, this.canvasRenderBuffer.context), d) l.isCanvas = !0, 
                            e.$texture = l; else {
                                var f = e.$texture;
                                f ? i.context.updateTexture(f, l) : (f = i.context.createTexture(l), e.$texture = f);
                            }
                            e.$textureWidth = l.width, e.$textureHeight = l.height;
                        }
                        var p = e.$textureWidth, g = e.$textureHeight;
                        i.context.drawTexture(e.$texture, 0, 0, p, g, 0, 0, p / o, g / s, p, g), (u || h) && (e.dirtyRender && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, 0, 0), 
                        i.transform(1, 0, 0, 1, -u / o, -h / s)), e.dirtyRender = !1;
                    }
                }
                ...
                if (!(n <= 0 || o <= 0) && n && o && 0 != e.drawData.length) {
                    ...
                    var u = Math.ceil(n), h = Math.ceil(o);
                    s *= u / n, c *= h / o, n = u, o = h;
                    var d = !!r.WebGLRenderContext.getInstance(0, 0).context.wxBindCanvasTexture;
                    if (d ? (this.canvasRenderer || (this.canvasRenderer = new t.CanvasRenderer()), 
                    ...
                    this.canvasRenderBuffer = new r.CanvasRenderBuffer(n, o)), this.canvasRenderBuffer.context) {
                        ...
                        if (a) {
                            ...
                            var f = void 0;
                            d ? (console.log("forHitTest"), l.isCanvas = !0, f = l) : (t.WebGLUtils.deleteWebGLTexture(l), 
                            f = i.context.getWebGLTexture(l)), i.context.drawTexture(f, 0, 0, n, o, 0, 0, n, o, l.width, l.height);
                        } else {
                            e.dirtyRender && (this.canvasRenderer.renderGraphics(e, this.canvasRenderBuffer.context), 
                            d ? (l.isCanvas = !0, e.$texture = l) : (f = e.$texture) ? i.context.updateTexture(f, l) : (f = i.context.createTexture(l), 
                            e.$texture = f), e.$textureWidth = l.width, e.$textureHeight = l.height);
                            var p = e.$textureWidth, g = e.$textureHeight;
                ...
                for (var c = e.drawData, u = c.length, h = 0; h < u; h++) {
                    var d = c[h];
