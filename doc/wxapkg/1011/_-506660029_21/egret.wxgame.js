...
function(e) {
    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(i, e), Object.defineProperty(i.prototype, "response", {
                ...
                }, a = wx.getFileSystemManager(), n = e._url;
                window.LocationProperty && null != window.catchPathDic[n] && -1 == (n = n.replace(LocationProperty.resAdd, "" + window.WX_ROOT)).lastIndexOf(".json") && (e.responseType = "arraybuffer"), 
                ...
                var t = !1, i = !1;
                if (window.LocationProperty && null != window.catchPathDic[this._url]) {
                    i = !0;
                    var a = this._url.replace(LocationProperty.resAdd, "");
                    t = window.existsSync(a);
                }
                if (t || !this.isNetUrl(this._url)) this.readFileAsync(); else {
                    var n = this;
                    wx.request({
                        data: e,
                        url: this._url,
                        ...
                        success: function(e) {
                            var t = e.data, a = e.statusCode, o = e.header;
                            if (200 == a) {
                                if (i && (window.catchArr.push(n._url), window.catchDataDic[n._url] = t), "string" != typeof t && !(t instanceof ArrayBuffer)) try {
                                    t = JSON.stringify(t);
                                } catch (e) {
                                    t = t;
                                }
                                n._responseHeader = o, n._response = t, n.dispatchEventWith(r.Event.COMPLETE);
                            } else n.dispatchEventWith(r.IOErrorEvent.IO_ERROR);
                        },
                        fail: function(e) {
                            n.dispatchEventWith(r.IOErrorEvent.IO_ERROR);
                        }
    ...
    !function(i) {
        ...
        var a = function(e) {
            ...
            return t(a, e), Object.defineProperty(a.prototype, "crossOrigin", {
                ...
                var r = !1, i = !1, n = "";
                if (window.LocationProperty) {
                    if (null != window.catchPathDic[e]) {
                        i = !0;
                        var o = e.replace(LocationProperty.resAdd, "");
                        r = window.existsSync(o), n = e.replace(LocationProperty.resAdd, "" + window.WX_ROOT);
                    }
                    if (r) null != window.mobileInfo && "ios" == window.mobileInfo.platform ? t.src = n : n.indexOf("/res/") > -1 ? window.setTimeout(function() {
                        t.src = n;
                    }, 500) : t.src = n; else if (i) {
                        window.deleteFile(e);
                        var s = dirname(n).replace("" + window.WX_ROOT, "");
                        window.mkdirsSync(s), wx.downloadFile({
                            url: e,
                            filePath: n,
                            success: function(e) {
                                if (e.statusCode >= 400) {
                                    var r = "加载失败:" + url;
                                    console.error(r), t.onerror({
                                        target: t
                                    });
                                } else t.src = n;
                            },
                            fail: function(e) {
                                console.error(e), t.onerror({
                                    target: t
                                });
                            }
                        });
    ...
    !function(e) {
        e.version = "1.1.5", e.isSubContext = !1, e.preUploadTexture = !1;
    }(e.wxgame || (e.wxgame = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
        function r(r) {
    ...
    !function(t) {
        var r = function() {
            ...
            return e.prototype.reachMaxSize = function(e, t) {
                ...
                if (d) {
                    var R = this.vertices, A = this.vertexIndex * this.vertSize, _ = 0, O = 0, D = 0, M = 0, B = 0, I = 0, $ = 0;
                    for (_ = 0, D = l.length; _ < D; _ += 2) O = A + 5 * _ / 2, I = d[_], $ = d[_ + 1], 
                    M = l[_], B = l[_ + 1], R[O + 0] = x * I + y * $ + b, R[O + 1] = m * I + w * $ + T, 
                    p ? (R[O + 2] = (t + (1 - B) * a) / h, R[O + 3] = (r + M * i) / u) : (R[O + 2] = (t + M * i) / h, 
                    R[O + 3] = (r + B * a) / u), R[O + 4] = g;
                    ...
                    if (p) {
                        var U = i;
                        i = a / G, a = U / W, R[A++] = b, R[A++] = T, R[A++] = i + t, R[A++] = r, R[A++] = g, 
    ...
    !function(r) {
        var i = function() {
            ...
            return e.getInstance = function(t, r) {
                ...
                var a = this.surface;
                i ? (a.width < e && (a.width = e, !r.isSubContext && window.sharedCanvas && (window.sharedCanvas.width = e)), 
                a.height < t && (a.height = t, !r.isSubContext && window.sharedCanvas && (window.sharedCanvas.height = t))) : (a.width != e && (a.width = e, 
                !r.isSubContext && window.sharedCanvas && (window.sharedCanvas.width = e)), a.height != t && (a.height = t, 
                !r.isSubContext && window.sharedCanvas && (window.sharedCanvas.height = t))), this.onResize();
                ...
                var r = this.context;
                if (e.isCanvas && null != r.wxBindCanvasTexture) return e;
                var i = r.createTexture();
                {
                    if (i) {
                        i.glContext = r, r.bindTexture(r.TEXTURE_2D, i), r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 1);
                        var a = 0;
                        return null != e.src && null != t.gameTextureType && (a = t.gameTextureType(e.src)), 
                        1 == a ? r.texImage2D(r.TEXTURE_2D, 0, r.RGB, r.RGB, r.UNSIGNED_SHORT_5_6_5, e) : 2 == a ? r.texImage2D(r.TEXTURE_2D, 0, r.RGBA, r.RGBA, r.UNSIGNED_SHORT_4_4_4_4, e) : r.texImage2D(r.TEXTURE_2D, 0, r.RGBA, r.RGBA, r.UNSIGNED_BYTE, e), 
                        r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MAG_FILTER, r.LINEAR), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER, r.LINEAR), 
        ...
        r.WebGLRenderContext = i, e(i.prototype, "egret.wxgame.WebGLRenderContext"), i.initBlendMode();
    }(t.wxgame || (t.wxgame = {}));
    ...
    !function(r) {
        var i = [ "source-over", "lighter", "destination-out" ], a = [], n = function() {
            ...
            return e.prototype.render = function(e, r, i, n) {
                ...
                var l = e.$getOriginalBounds(), d = l.x, f = l.y, p = l.width, g = l.height;
                if (p <= 0 || g <= 0) return s;
                ...
                if (x.context.pushBuffer(x), e.$mask ? s += this.drawWithClip(e, x, -d, -f) : e.$scrollRect || e.$maskRect ? s += this.drawWithScrollRect(e, x, -d, -f) : s += this.drawDisplayObject(e, x, -d, -f), 
                x.context.popBuffer(), s > 0) {
                    u && r.context.setGlobalCompositeOperation(c), s++, r.$offsetX = n + d, r.$offsetY = o + f;
                ...
                if (l || e.$children && 0 != e.$children.length) {
                    ...
                    if (m.context.pushBuffer(m), c += this.drawDisplayObject(e, m, -p, -g), l) {
                        var y = this.createRenderBuffer(v, x);
                        y.context.pushBuffer(y);
                        var w = t.Matrix.create();
                        w.copyFrom(l.$getConcatenatedMatrix()), l.$getConcatenatedMatrixAt(e, w), w.translate(-p, -g), 
                        y.setTransform(w.a, w.b, w.c, w.d, w.tx, w.ty), t.Matrix.release(w), c += this.drawDisplayObject(l, y, 0, 0), 
                ...
                if (t.$hasScissor || 0 != o.b || 0 != o.c) t.context.pushMask(n.x + r, n.y + i, n.width, n.height); else {
                    ...
                    if (1 == h && 1 == u) x = f + l, m = p + d, y = g + l, w = v + d; else {
                        var b = h * f + l, T = u * p + d, E = h * g + l, C = u * p + d, S = h * g + l, L = u * v + d, R = h * f + l, A = u * v + d, _ = 0;
                        b > E && (_ = b, b = E, E = _), S > R && (_ = S, S = R, R = _), x = b < S ? b : S, 
                        y = E > R ? E : R, T > C && (_ = T, T = C, C = _), L > A && (_ = L, L = A, A = _), 
                        m = T < L ? T : L, w = C > A ? C : A;
                    }
