...
!function(e) {
    ...
    var n = function() {
        ...
        return t.prototype.init = function() {
            ...
            e.fileSystem.addFile(r.url, r.type, r.root, r.extra), r.name && (this.config.alias[r.name] = r.url));
        }, t.prototype.removeResourceData = function(r) {
            e.hasRes(r.name) && (e.fileSystem.removeFile(r.url), this.config.alias[r.name] && delete this.config.alias[r.name]);
    ...
    var o = function() {
        ...
        return t.prototype.load = function(e, t, o, n) {
            ...
            for (var r = this, t = this; this.loadingCount < this.thread && "break" !== function() {
                ...
                return o ? (t.loadingCount++, void t.loadResource(o).then(function(t) {
                    ...
                    if (i && i.onProgress && i.onProgress(s, a), s == a) {
                        ...
                        delete r.reporterDic[n], delete r.groupErrorDic[n];
                    ...
                    if (s && s.onProgress && s.onProgress(a, u), a == u) {
                        ...
                        delete r.itemListDic[i], delete r.groupErrorDic[i], delete r.reporterDic[i];
            ...
            if (t) {
                ...
                return e.host.remove(r), 1 == r.extra && e.config.removeResourceData(r), o;
            }
    ...
    !function(o) {
        ...
        o.isSupport = function(e) {
            ...
            onLoadStart: function(t, o) {
                return n(this, void 0, void 0, function() {
                    var n, s, a, c, f, l, p, d, h, v;
                    return i(this, function(i) {
                        switch (i.label) {
                          case 0:
                            return [ 4, t.load(o, "json") ];

                          case 1:
                            return n = i.sent(), (s = t.resourceConfig.getResource(e.nameSelector(n.file))) || (a = u(o.url, n.file), 
                            s = {
                                name: a,
                                url: a,
                                type: "image",
                          ...
                          case 2:
                            d = i.sent(), c = n.frames, (f = new r.SpriteSheet(d)).$resourceInfo = s;
                            for (l in c) p = c[l], d = f.createTexture(l, p.x, p.y, p.w, p.h, p.offX, p.offY, p.sourceW, p.sourceH), 
                            p.scale9grid && (h = p.scale9grid, v = h.split(","), d.scale9Grid = new r.Rectangle(parseInt(v[0]), parseInt(v[1]), parseInt(v[2]), parseInt(v[3])));
                            return t.save(s, d), [ 2, f ];
                        }
                    });
                });
            },
                    ...
                    return i(this, function(i) {
                        switch (i.label) {
                          ...
                          case 1:
                            ...
                            return a = "string" == typeof s ? f(o.url, s) : u(o.url, s.file), (c = t.resourceConfig.getResource(e.nameSelector(a))) || (c = {
                                name: a,
                                url: a,
                                type: "image",
                                root: o.root
                          ...
                          case 2:
                            return l = i.sent(), p = new r.BitmapFont(l, s), p.$resourceInfo = c, t.save(c, l), 
                            [ 2, p ];
                        }
                    });
                });
            ...
            onLoadStart: function(r, t) {
                return r.load(t, "json").then(function(o) {
                    ...
                    for (var a = n.groups, u = 0, c = o.groups; u < c.length; u++) {
                        var f = c[u];
                        a[f.name] = f.keys.split(",");
                    }
                    for (var l = n.alias, p = s.fsData, d = 0, h = o.resources; d < h.length; d++) !function(e) {
...
!function(e) {
    ...
    var a = function(r) {
        ...
        return o(t, r), t.prototype.loadConfig = function() {
            ...
            return e.queue.loadResource(a).then(function(n) {
                e.host.save(a, n);
            ...
            return e.queue.loadResource(s).then(function(r) {
