...
!function(e, n) {
    ...
    function i() {
        for (var t = 0; F > t; t += 2) (0, G[t])(G[t + 1]), G[t] = void 0, G[t + 1] = void 0;
        F = 0;
    }
    function s(t, e) {
    ...
    function d(t, e) {
        e._state === Q ? m(t, e._result) : e._state === R ? b(t, e._result) : g(e, void 0, function(e) {
            return _(t, e);
        }, function(e) {
            return b(t, e);
        });
    ...
    function _(t, n) {
        t === n ? b(t, a()) : e(n) ? v(t, n, l(n)) : m(t, n);
    }
    function y(t) {
        t._onerror && t._onerror(t._result), w(t);
    }
    function m(t, e) {
        t._state === J && (t._result = e, t._state = Q, 0 !== t._subscribers.length && L(w, t));
    }
    function b(t, e) {
    ...
    function g(t, e, n, r) {
        ...
        t._onerror = null, o[i] = e, o[i + Q] = n, o[i + R] = r, 0 === i && t._state && L(w, t);
    }
    function w(t) {
    ...
    function j(t, e, r, o) {
        var i = n(r), s = void 0, u = void 0, c = void 0, a = void 0;
        if (i) {
            if ((s = S(r, o)) === X ? (a = !0, u = s.error, s = null) : c = !0, e === s) return void b(e, f());
        } else s = o, c = !0;
        e._state !== J || (i && c ? _(e, s) : a ? b(e, u) : t === Q ? m(e, s) : t === R && b(e, s));
    }
    function E(t, e) {
        try {
            e(function(e) {
    ...
    function x(t, e) {
        this._instanceConstructor = t, this.promise = new t(c), this.promise[I] || T(this.promise), 
        ...
        this._enumerate(), 0 === this._remaining && m(this.promise, this._result))) : b(this.promise, M());
    }
    function M() {
    ...
    function k(t) {
        this[I] = P(), this._result = this._state = void 0, this._subscribers = [], c !== t && ("function" != typeof t && C(), 
    ...
    return x.prototype._enumerate = function() {
        for (var t = this.length, e = this._input, n = 0; this._state === J && t > n; n++) this._eachEntry(e[n], n);
        ...
        var e = t.Promise;
        if ("undefined" != typeof egret_native && egret_native.capability && !egret_native.capability("Promise") && (e = void 0), 
        e) {
            var n = null;
            try {
