    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(i, e), i.prototype.addFps = function() {
                ...
                var d = this.WIDTH, l = this.HEIGHT, f = this.contextFps;
                f.drawImage(this.canvasFps, 1, 0, d - 1, l, 0, 0, d - 1, l), f.fillStyle = this.bgCanvasColor, 
                f.fillRect(d - 1, 0, 1, l);
                var p = Math.floor(r / 60 * 20);
                p < 1 && (p = 1), f.fillStyle = this.fpsFrontColor, f.fillRect(d - 1, 20 - p, 1, p);
                var g = this.WIDTH_COST;
                (f = this.contextCost).drawImage(this.canvasCost, 1, 0, g - 1, l, 0, 0, g - 1, l), 
                f.drawImage(this.canvasCost, g + 2, 0, g - 1, l, g + 1, 0, g - 1, l);
                var v = Math.floor(i / 2);
                v < 1 ? v = 1 : v > 20 && (v = 20);
                var x = Math.floor(a / 2);
                x < 1 ? x = 1 : x > 20 && (x = 20), f.fillStyle = this.bgCanvasColor, f.fillRect(g - 1, 0, 1, l), 
                f.fillRect(2 * g, 0, 1, l), f.fillRect(3 * g + 1, 0, 1, l), f.fillStyle = this.cost1Color, 
        ...
        i.WebFps = a, e(a.prototype, "egret.wxgame.WebFps", [ "egret.FPSDisplay" ]), r.FPSDisplay = a;
    }(r.wxgame || (r.wxgame = {}));
...
function(e) {
    ...
    !function(e) {
        e.version = "1.1.7", e.isSubContext = !1, e.preUploadTexture = !1;
    }(e.wxgame || (e.wxgame = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
        function r(r) {
    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(a, e), a.prototype.init = function(e, t) {
                ...
                i.textureScaleFactor = 1, i.showFPS = !1;
    ...
    !function(t) {
        function r(t, r) {
            ...
            "webgl" == e.Capabilities.renderMode) {
                ...
                for (var d = u.$renderBuffer.getPixels(r.x, r.y, s, c), l = 0, f = 0, p = 0; p < d.length; p += 4) a.fillStyle = "rgba(" + d[p] + "," + d[p + 1] + "," + d[p + 2] + "," + d[p + 3] / 255 + ")", 
            ...
            return e.prototype.render = function(e, r, i, n) {
                ...
                if (t.$hasScissor || 0 != o.b || 0 != o.c) t.context.pushMask(n.x + r, n.y + i, n.width, n.height); else {
                    ...
                    if (1 == h && 1 == u) x = f + d, m = p + l, y = g + d, w = v + l; else {
                        var b = h * f + d, T = u * p + l, E = h * g + d, C = u * p + l, S = h * g + d, L = u * v + l, R = h * f + d, A = u * v + l, O = 0;
                ...
                var a = e.image;
                if (a) {
                    var n, o, s, c = e.drawData, h = c.length, u = 0, d = e.matrix, l = e.blendMode, f = e.alpha;
                    if (d) {
                        n = t.Matrix.create();
                ...
                var a, n, o, s = e.image, c = e.drawData, h = c.length, u = 0, d = e.matrix, l = e.blendMode, f = e.alpha;
                if (d) {
                    a = t.Matrix.create();
                    var p = r.globalMatrix;
