    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(i, e), i.prototype.addFps = function() {
                ...
                var d = this.WIDTH, l = this.HEIGHT, p = this.contextFps;
                p.drawImage(this.canvasFps, 1, 0, d - 1, l, 0, 0, d - 1, l), p.fillStyle = this.bgCanvasColor, 
                p.fillRect(d - 1, 0, 1, l);
                var f = Math.floor(r / 60 * 20);
                f < 1 && (f = 1), p.fillStyle = this.fpsFrontColor, p.fillRect(d - 1, 20 - f, 1, f);
                var g = this.WIDTH_COST;
                (p = this.contextCost).drawImage(this.canvasCost, 1, 0, g - 1, l, 0, 0, g - 1, l), 
                p.drawImage(this.canvasCost, g + 2, 0, g - 1, l, g + 1, 0, g - 1, l);
                var v = Math.floor(i / 2);
                v < 1 ? v = 1 : v > 20 && (v = 20);
                var x = Math.floor(a / 2);
                x < 1 ? x = 1 : x > 20 && (x = 20), p.fillStyle = this.bgCanvasColor, p.fillRect(g - 1, 0, 1, l), 
                p.fillRect(2 * g, 0, 1, l), p.fillRect(3 * g + 1, 0, 1, l), p.fillStyle = this.cost1Color, 
                p.fillRect(g - 1, 20 - v, 1, v), p.fillStyle = this.cost3Color, p.fillRect(2 * g, 20 - x, 1, x);
                var y = Math.floor(n / o), m = r + " FPS " + this.renderMode;
                this.showPanle && (m += "<br/>min" + s + " max" + c + " avg" + y, this.divDraw.innerHTML = this.lastNumDraw + "<br/>", 
        ...
        i.WebFps = a, e(a.prototype, "egret.wxapp.WebFps", [ "egret.FPSDisplay", "egret.DisplayObject" ]), 
        r.FPSDisplay = a;
    }(r.wxapp || (r.wxapp = {}));
...
function(e) {
    e.wxapp || (e.wxapp = {}), e.registerClass(HTMLImageElement, "egret.BitmapData"), 
    ...
    !function(i) {
        ...
        i.HtmlSound = a, e(a.prototype, "egret.wxapp.HtmlSound", [ "egret.Sound" ]);
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
        ...
        i.HtmlSoundChannel = a, e(a.prototype, "egret.wxapp.HtmlSoundChannel", [ "egret.SoundChannel", "egret.IEventDispatcher" ]);
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function() {
        ...
        i.WebAudioDecode = a, e(a.prototype, "egret.wxapp.WebAudioDecode");
        var n = function(e) {
            function n() {
                var t = e.call(this) || this;
                return t.loaded = !1, t;
        ...
        i.WebAudioSound = n, e(n.prototype, "egret.wxapp.WebAudioSound", [ "egret.Sound" ]);
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
        ...
        i.WebAudioSoundChannel = a, e(a.prototype, "egret.wxapp.WebAudioSoundChannel", [ "egret.SoundChannel", "egret.IEventDispatcher" ]);
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
        ...
        i.WebVideo = a, e(a.prototype, "egret.wxapp.WebVideo", [ "egret.Video", "egret.DisplayObject" ]), 
        r.Video = a;
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        ...
        i.WebHttpRequest = a, e(a.prototype, "egret.wxapp.WebHttpRequest", [ "egret.HttpRequest" ]), 
        r.HttpRequest = a;
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        ...
        var a = function(e) {
            ...
            return t(a, e), Object.defineProperty(a.prototype, "crossOrigin", {
                ...
                if (t) {
                    this.data = new r.BitmapData(t), r.wxgame.preUploadTexture && "webgl" == r.Capabilities.renderMode && i.WebGLRenderContext.getInstance(null, null).getWebGLTexture(this.data);
                    var a = this;
                    window.setTimeout(function() {
                        a.dispatchEventWith(r.Event.COMPLETE);
                    }, 0);
        ...
        i.WebImageLoader = a, e(a.prototype, "egret.wxapp.WebImageLoader", [ "egret.ImageLoader" ]), 
        r.ImageLoader = a;
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        ...
        i.HTML5StageText = a, e(a.prototype, "egret.wxapp.HTML5StageText", [ "egret.StageText" ]), 
        r.StageText = a;
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
    ...
    !function(r) {
        ...
        var a = function() {
            function e(e, r, a) {
                a ? t.wxgame.isSubContext ? this.surface = window.sharedCanvas : this.surface = window.canvas : this.surface = i(e, r), 
            ...
            return Object.defineProperty(e.prototype, "width", {
                ...
                var a = this.surface;
                if (!t.wxgame.isSubContext) {
                    if (i) {
                        var n = !1;
                        a.width < e && (a.width = e, "canvas" === t.Capabilities.renderMode && (window.sharedCanvas.width = e), 
                        n = !0), a.height < r && (a.height = r, "canvas" === t.Capabilities.renderMode && (window.sharedCanvas.height = r), 
                        n = !0), n || (this.context.globalCompositeOperation = "source-over", this.context.setTransform(1, 0, 0, 1, 0, 0), 
                        this.context.globalAlpha = 1);
                    } else a.width != e && (a.width = e, "canvas" === t.Capabilities.renderMode && (window.sharedCanvas.width = e)), 
                    a.height != r && (a.height = r, "canvas" === t.Capabilities.renderMode && (window.sharedCanvas.height = r));
                    this.clear();
                }
        ...
        r.CanvasRenderBuffer = a, e(a.prototype, "egret.wxapp.CanvasRenderBuffer", [ "egret.sys.RenderBuffer" ]);
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
            ...
            return t(i, e), i.prototype.addTouchListener = function() {
                var e = this;
                r.wxgame.isSubContext ? (wx.onTouchStart(function(t) {
            ...
            }, i.prototype.updateScaleMode = function(e, t, r) {
                this.scaleX = e, this.scaleY = t, this.rotation = r;
            }, i.prototype.$updateMaxTouches = function() {
                this.touch.$initMaxTouches();
            }, i;
        }(r.HashObject);
        i.WebTouchHandler = a, e(a.prototype, "egret.wxapp.WebTouchHandler");
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(e) {
    !function(e) {
        e.WebLifeCycleHandler = function(e) {
            ...
            var t, r;
            void 0 !== document.hidden ? (t = "hidden", r = "visibilitychange") : void 0 !== document.mozHidden ? (t = "mozHidden", 
            r = "mozvisibilitychange") : void 0 !== document.msHidden ? (t = "msHidden", r = "msvisibilitychange") : void 0 !== document.webkitHidden ? (t = "webkitHidden", 
            r = "webkitvisibilitychange") : void 0 !== document.oHidden && (t = "oHidden", r = "ovisibilitychange"), 
            "onpageshow" in window && "onpagehide" in window && (window.addEventListener("pageshow", e.resume, !1), 
            window.addEventListener("pagehide", e.pause, !1)), t && r && document.addEventListener(r, function() {
                document[t] ? e.pause() : e.resume();
            }, !1);
            var i = navigator.userAgent, a = /micromessenger/gi.test(i), n = /mqq/gi.test(i);
            if ((/mobile.*qq/gi.test(i) || a) && (n = !1), n) {
    ...
    !function(i) {
        ...
        i.AudioType = n, e(n.prototype, "egret.wxapp.AudioType");
        var o = function(e) {
            function a() {
            ...
            return t(a, e), a.$init = function() {
                ...
                switch (a._audioType = e, e) {
                  case n.WEB_AUDIO:
                    a._AudioClass = r.wxapp.WebAudioSound;
                    break;

                  case n.HTML5_AUDIO:
                    a._AudioClass = r.wxapp.HtmlSound;
                }
        ...
        i.Html5Capatibility = o, e(o.prototype, "egret.wxapp.Html5Capatibility");
        var s = null;
    ...
    !function(e) {
        e.version = "1.1.1", e.isSubContext = !1, e.preUploadTexture = !1;
    }(e.wxgame || (e.wxgame = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
        function r(r) {
        ...
        e.runEgret = function(s) {
            if (!n) {
                ...
                e.Capabilities.runtimeType = e.RuntimeType.WXGAME, e.sys.CanvasRenderBuffer = t.CanvasRenderBuffer, 
                r(s.renderMode);
                var h;
                if (s.canvasScaleFactor) h = s.canvasScaleFactor; else if (s.calculateCanvasScaleFactor) h = s.calculateCanvasScaleFactor(e.sys.canvasHitTestBuffer.context); else {
                    var u = e.sys.canvasHitTestBuffer.context, d = u.backingStorePixelRatio || u.webkitBackingStorePixelRatio || u.mozBackingStorePixelRatio || u.msBackingStorePixelRatio || u.oBackingStorePixelRatio || u.backingStorePixelRatio || 1;
                ...
                var l = {}, p = new t.WebPlayer(l, s);
                window.player = p, window.addEventListener("resize", function() {
...
(r = r.replace("-", "_")) in egret.$locale_strings && (egret.$language = r), function(t) {
    !function(r) {
        var i = function() {
            function e() {}
        ...
        r.WebCapability = i, e(i.prototype, "egret.wxapp.WebCapability"), i.detect();
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(r) {
        var i = function() {
        ...
        r.WebExternalInterface = i, e(i.prototype, "egret.wxapp.WebExternalInterface", [ "egret.ExternalInterface" ]), 
    ...
    !function(r) {
        ...
        r.NativeExternalInterface = a, e(a.prototype, "egret.wxapp.NativeExternalInterface", [ "egret.ExternalInterface" ]), 
    ...
    !function(i) {
        var a = function(e) {
            ...
            return t(a, e), a.prototype.init = function(e, t) {
                ...
                var e = this.canvas;
                if (!e.userTyping) {
                    var t = this.playerOption, i = e.getBoundingClientRect(), a = 0, n = i.width, o = i.height;
                    i.top < 0 && (o += i.top, a = -i.top);
                    var s = !1, c = this.stage.$orientation;
                    c != r.OrientationMode.AUTO && (s = c != r.OrientationMode.PORTRAIT && o > n || c == r.OrientationMode.PORTRAIT && n > o);
                    var h = s ? o : n, u = s ? n : o;
                    r.Capabilities.boundingClientWidth = h, r.Capabilities.boundingClientHeight = u;
                    var d = r.sys.screenAdapter.calculateStageSize(this.stage.$scaleMode, h, u, t.contentWidth, t.contentHeight), l = d.stageWidth, p = d.stageHeight, f = d.displayWidth, g = d.displayHeight;
                    e.style[r.wxapp.getPrefixStyleName("transformOrigin")] = "0% 0% 0px", e.width != l && (r.wxgame.isSubContext || (window.sharedCanvas && (window.sharedCanvas.width = l), 
                    e.width = l)), e.height != p && (r.wxgame.isSubContext || (window.sharedCanvas && (window.sharedCanvas.height = p), 
                    e.height = p));
                    var v = 0;
                    s ? c == r.OrientationMode.LANDSCAPE ? (v = 90, e.style.top = a + (o - f) / 2 + "px", 
                    e.style.left = (n + g) / 2 + "px") : (v = -90, e.style.top = a + (o + f) / 2 + "px", 
                    e.style.left = (n - g) / 2 + "px") : (e.style.top = a + (o - g) / 2 + "px", e.style.left = (n - f) / 2 + "px");
                    var x = f / l, y = g / p, m = x * r.sys.DisplayList.$canvasScaleFactor, w = y * r.sys.DisplayList.$canvasScaleFactor, b = new r.Matrix();
                    b.scale(x / m, y / w), b.rotate(v * Math.PI / 180);
                    var T = "matrix(" + b.a + "," + b.b + "," + b.c + "," + b.d + "," + b.tx + "," + b.ty + ")";
                    e.style[r.wxapp.getPrefixStyleName("transform")] = T, r.sys.DisplayList.$setCanvasScale(m, w), 
                    this.webTouchHandler.updateScaleMode(x, y, v), this.player.updateStageSize(l, p);
                }
        ...
        i.WebPlayer = a, e(a.prototype, "egret.wxapp.WebPlayer", [ "egret.sys.Screen" ]);
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
        function r(t, r) {
            ...
            "webgl" == e.Capabilities.renderMode) {
                ...
                for (var d = u.$renderBuffer.getPixels(r.x, r.y, s, c), l = 0, p = 0, f = 0; f < d.length; f += 4) a.fillStyle = "rgba(" + d[f] + "," + d[f + 1] + "," + d[f + 2] + "," + d[f + 3] / 255 + ")", 
                a.fillRect(l, p, 1, 1), ++l == s && (l = 0, p++);
                return t.$renderBuffer || u.dispose(), h;
            }
            var g = t, v = Math.round(g.$offsetX), x = Math.round(g.$offsetY), y = g.$bitmapWidth, m = g.$bitmapHeight;
            return a.drawImage(g.$bitmapData.source, g.$bitmapX + r.x / e.$TextureScaleFactor, g.$bitmapY + r.y / e.$TextureScaleFactor, y * r.width / n, m * r.height / o, v, x, r.width, r.height), 
            h;
        }
        var i, a;
    ...
    !function(i) {
        function a(e, t) {
            ...
            for (var r = new o(e.localName, t, e.prefix, e.namespaceURI, e.nodeName), i = e.attributes, n = r.attributes, c = i.length, h = 0; h < c; h++) {
                var u = i[h], d = u.name;
                0 != d.indexOf("xmlns:") && (n[d] = u.value, r["$" + d] = u.value);
            }
            var l = e.childNodes;
            c = l.length;
            for (var p = r.children, h = 0; h < c; h++) {
                var f = l[h], g = f.nodeType, v = null;
                if (1 == g) v = a(f, r); else if (3 == g) {
                    var x = f.textContent.trim();
                    x && (v = new s(x, r));
                }
                v && p.push(v);
            }
        ...
        i.XMLNode = n, e(n.prototype, "egret.wxapp.XMLNode");
        var o = function(e) {
        ...
        i.XML = o, e(o.prototype, "egret.wxapp.XML");
        var s = function(e) {
            function r(t, r) {
        ...
        i.XMLText = s, e(s.prototype, "egret.wxapp.XMLText");
        var c;
        r.XML = {
            parse: function(e) {
    ...
    !function(i) {
        ...
        i.WebDeviceOrientation = a, e(a.prototype, "egret.wxapp.WebDeviceOrientation", [ "egret.DeviceOrientation" ]);
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), egret.DeviceOrientation = egret.wxapp.WebDeviceOrientation, 
function(r) {
    !function(i) {
        var a = function(e) {
            function i(t) {
        ...
        i.WebGeolocation = a, e(a.prototype, "egret.wxapp.WebGeolocation", [ "egret.Geolocation" ]), 
        r.Geolocation = r.wxapp.WebGeolocation;
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
        ...
        i.WebMotion = a, e(a.prototype, "egret.wxapp.WebMotion", [ "egret.Motion" ]), r.Motion = r.wxapp.WebMotion;
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(e) {
    !function(t) {
        var r;
    ...
    !function(t) {
        var r = function() {
            ...
            return e.prototype.pushDrawRect = function() {
                ...
                r.type = 10, r.texture = e, r.smoothing = t, this.drawData[this.drawDataLen] = r, 
                this.drawDataLen++;
                ...
                for (var t = !1, r = this.drawDataLen - 1; r >= 0; r--) {
                    ...
                    if (i) {
                        if (0 != i.type && 1 != i.type || (t = !0), !t && 4 == i.type) {
                ...
                i.type = 5, i.buffer = e, i.width = t, i.height = r, this.drawData[this.drawDataLen] = i, 
                this.drawDataLen++;
                ...
                for (var t = !1, r = this.drawDataLen - 1; r >= 0; r--) {
                    var i = this.drawData[r];
                    !i || (4 != i.type && 7 != i.type && (t = !0), t || 7 != i.type) || (this.drawData.splice(r, 1), 
                    this.drawDataLen--);
                }
                var a = this.drawData[this.drawDataLen] || {};
                a.type = 7, a.buffer = e, a.width = e.rootRenderTarget.width, a.height = e.rootRenderTarget.height, 
                this.drawData[this.drawDataLen] = a, this.drawDataLen++;
            }, e.prototype.pushEnableScissor = function(e, t, r, i) {
                var a = this.drawData[this.drawDataLen] || {};
                a.type = 8, a.x = e, a.y = t, a.width = r, a.height = i, this.drawData[this.drawDataLen] = a, 
                this.drawDataLen++;
        ...
        t.WebGLDrawCmdManager = r, e(r.prototype, "egret.wxapp.WebGLDrawCmdManager");
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(t) {
        var r = function() {
            ...
            return e.prototype.reachMaxSize = function(e, t) {
                ...
                return this.hasMesh;
            }, e.prototype.cacheArrays = function(e, t, r, i, a, n, o, s, c, h, u, d, l, p, f) {
                var g = e.globalAlpha, v = e.globalMatrix, x = v.a, y = v.b, m = v.c, w = v.d, b = v.tx, T = v.ty, E = e.$offsetX, C = e.$offsetY;
                if (0 == E && 0 == C || (b = E * x + C * m + b, T = E * y + C * w + T), !l) {
                    0 == n && 0 == o || (b = n * x + o * m + b, T = n * y + o * w + T);
                    var L = s / i;
                    1 != L && (x *= L, y *= L);
                    var S = c / a;
                    1 != S && (m *= S, w *= S);
                ...
                if (l) {
                    ...
                    for (O = 0, D = d.length; O < D; O += 2) _ = A + 5 * O / 2, I = l[O], $ = l[O + 1], 
                    M = d[O], B = d[O + 1], R[_ + 0] = x * I + m * $ + b, R[_ + 1] = y * I + w * $ + T, 
                    f ? (R[_ + 2] = (t + (1 - B) * a) / h, R[_ + 3] = (r + M * i) / u) : (R[_ + 2] = (t + M * i) / h, 
                    R[_ + 3] = (r + B * a) / u), R[_ + 4] = g;
                    if (this.hasMesh) for (var F = 0, P = p.length; F < P; ++F) this.indicesForMesh[this.indexIndex + F] = p[F] + this.vertexIndex;
                    ...
                    if (f) {
                        ...
                        R[A++] = x * N + b, R[A++] = y * N + T, R[A++] = i + t, R[A++] = a + r, R[A++] = g, 
                        R[A++] = x * N + m * H + b, R[A++] = w * H + y * N + T, R[A++] = t, R[A++] = a + r, 
                        R[A++] = g, R[A++] = m * H + b, R[A++] = w * H + T, R[A++] = t, R[A++] = r, R[A++] = g;
                    } else i /= W, a /= G, R[A++] = b, R[A++] = T, R[A++] = t, R[A++] = r, R[A++] = g, 
                    R[A++] = x * N + b, R[A++] = y * N + T, R[A++] = i + t, R[A++] = r, R[A++] = g, 
                    R[A++] = x * N + m * H + b, R[A++] = w * H + y * N + T, R[A++] = i + t, R[A++] = a + r, 
                    R[A++] = g, R[A++] = m * H + b, R[A++] = w * H + T, R[A++] = t, R[A++] = a + r, 
                    R[A++] = g;
                    if (this.hasMesh) {
        ...
        t.WebGLVertexArrayObject = r, e(r.prototype, "egret.wxapp.WebGLVertexArrayObject");
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
        ...
        i.WebGLRenderTarget = a, e(a.prototype, "egret.wxapp.WebGLRenderTarget");
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(r) {
        var i = function() {
            function e(e, t) {
                ...
                i.bindBuffer(i.ELEMENT_ARRAY_BUFFER, this.indexBuffer), this.drawCmdManager = new r.WebGLDrawCmdManager(), 
                this.vao = new r.WebGLVertexArrayObject(), this.setGlobalCompositeOperation("source-over");
            }
            return e.getInstance = function(t, r) {
            ...
            }, e.prototype.activateBuffer = function(e) {
                e.rootRenderTarget.activate(), this.bindIndices || this.uploadIndicesArray(this.vao.getIndices()), 
                e.restoreStencil(), e.restoreScissor(), this.onResize(e.width, e.height);
                ...
                var a = this.surface;
                i ? (a.width < e && (a.width = e, !t.wxgame.isSubContext && window.sharedCanvas && (window.sharedCanvas.width = e)), 
                a.height < r && (a.height = r, !t.wxgame.isSubContext && window.sharedCanvas && (window.sharedCanvas.height = r))) : (a.width != e && (a.width = e, 
                !t.wxgame.isSubContext && window.sharedCanvas && (window.sharedCanvas.width = e)), 
                a.height != r && (a.height = r, !t.wxgame.isSubContext && window.sharedCanvas && (window.sharedCanvas.height = r))), 
                this.onResize();
                ...
                if (!this.contextLost && e && p) {
                    var f, g, v;
                    if (e.texture || e.source && e.source.texture) f = e.texture || e.source.texture, 
                    p.saveTransform(), g = p.$offsetX, v = p.$offsetY, p.useOffset(), p.transform(1, 0, 0, -1, 0, c + 2 * o); else {
                        if (!e.source && !e.webGLTexture) return;
                        f = this.getWebGLTexture(e);
                    }
                    f && (this.drawTexture(f, t, r, i, a, n, o, s, c, h, u, void 0, void 0, void 0, void 0, d, l), 
                    e.source && e.source.texture && (p.$offsetX = g, p.$offsetY = v, p.restoreTransform()));
                }
            }, e.prototype.drawMesh = function(e, t, r, i, a, n, o, s, c, h, u, d, l, p, f, g, v) {
                var x = this.currentBuffer;
                if (!this.contextLost && e && x) {
                    var y, m, w;
                    if (e.texture || e.source && e.source.texture) y = e.texture || e.source.texture, 
                    x.saveTransform(), m = x.$offsetX, w = x.$offsetY, x.useOffset(), x.transform(1, 0, 0, -1, 0, c + 2 * o); else {
                        if (!e.source && !e.webGLTexture) return;
                        y = this.getWebGLTexture(e);
                    }
                    y && (this.drawTexture(y, t, r, i, a, n, o, s, c, h, u, d, l, p, f, g, v), (e.texture || e.source && e.source.texture) && (x.$offsetX = m, 
                    x.$offsetY = w, x.restoreTransform()));
                }
            }, e.prototype.drawTexture = function(e, t, r, i, a, n, o, s, c, h, u, d, l, p, f, g, v) {
                var x = this.currentBuffer;
                if (!this.contextLost && e && x) {
                    l && p ? this.vao.reachMaxSize(l.length / 2, p.length) && this.$drawWebGL() : this.vao.reachMaxSize() && this.$drawWebGL(), 
                    void 0 != v && e.smoothing != v && this.drawCmdManager.pushChangeSmoothing(e, v), 
                    d && this.vao.changeToMeshIndices();
                    var y = p ? p.length / 3 : 2;
                    this.drawCmdManager.pushDrawTexture(e, y, this.$filter), this.vao.cacheArrays(x, t, r, i, a, n, o, s, c, h, u, d, l, p, g);
                }
            ...
            }, e.prototype.drawData = function(e, t) {
                if (e) {
                    var i, a = this.context, n = e.filter;
                    switch (e.type) {
                      case 0:
                        n ? "custom" === n.type ? i = r.EgretWebGLProgram.getProgram(a, n.$vertexSrc, n.$fragmentSrc, n.$shaderKey) : "colorTransform" === n.type ? i = r.EgretWebGLProgram.getProgram(a, r.EgretShaderLib.default_vert, r.EgretShaderLib.colorTransform_frag, "colorTransform") : "blurX" === n.type ? i = r.EgretWebGLProgram.getProgram(a, r.EgretShaderLib.default_vert, r.EgretShaderLib.blur_frag, "blur") : "blurY" === n.type ? i = r.EgretWebGLProgram.getProgram(a, r.EgretShaderLib.default_vert, r.EgretShaderLib.blur_frag, "blur") : "glow" === n.type && (i = r.EgretWebGLProgram.getProgram(a, r.EgretShaderLib.default_vert, r.EgretShaderLib.glow_frag, "glow")) : i = r.EgretWebGLProgram.getProgram(a, r.EgretShaderLib.default_vert, r.EgretShaderLib.texture_frag, "texture"), 
                        this.activeProgram(a, i), this.syncUniforms(i, n, e.textureWidth, e.textureHeight), 
                        t += this.drawTextureElements(e, t);
                        break;

                      case 1:
                        i = r.EgretWebGLProgram.getProgram(a, r.EgretShaderLib.default_vert, r.EgretShaderLib.primitive_frag, "primitive"), 
                        this.activeProgram(a, i), this.syncUniforms(i, n, e.textureWidth, e.textureHeight), 
            ...
            }, e.prototype.drawTargetWidthFilters = function(e, t) {
                var i, a = t, n = e.length;
                if (n > 1) for (var o = 0; o < n - 1; o++) {
                    var s = e[o], c = t.rootRenderTarget.width, h = t.rootRenderTarget.height;
                    (i = r.WebGLRenderBuffer.create(c, h)).setTransform(1, 0, 0, 1, 0, 0), i.globalAlpha = 1, 
                    this.drawToRenderTarget(s, t, i), t != a && r.WebGLRenderBuffer.release(t), t = i;
                }
                var u = e[n - 1];
                this.drawToRenderTarget(u, t, this.currentBuffer), t != a && r.WebGLRenderBuffer.release(t);
            }, e.prototype.drawToRenderTarget = function(e, t, i) {
                if (!this.contextLost) {
                    this.vao.reachMaxSize() && this.$drawWebGL(), this.pushBuffer(i);
                    var a, n = t, o = t.rootRenderTarget.width, s = t.rootRenderTarget.height;
                    if ("blur" == e.type) {
                        var c = e.blurXFilter, h = e.blurYFilter;
                        0 != c.blurX && 0 != h.blurY ? ((a = r.WebGLRenderBuffer.create(o, s)).setTransform(1, 0, 0, 1, 0, 0), 
                        a.globalAlpha = 1, this.drawToRenderTarget(e.blurXFilter, t, a), t != n && r.WebGLRenderBuffer.release(t), 
                        t = a, e = h) : e = 0 === c.blurX ? h : c;
                    }
                    i.saveTransform(), i.transform(1, 0, 0, -1, 0, s), this.vao.cacheArrays(i, 0, 0, o, s, 0, 0, o, s, o, s), 
                    i.restoreTransform(), this.drawCmdManager.pushDrawTexture(t.rootRenderTarget.texture, 2, e, o, s), 
                    t != n && r.WebGLRenderBuffer.release(t), this.popBuffer();
                }
        ...
        r.WebGLRenderContext = i, e(i.prototype, "egret.wxapp.WebGLRenderContext"), i.initBlendMode();
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(r) {
    !function(i) {
        var a = function(e) {
        ...
        i.WebGLRenderBuffer = a, e(a.prototype, "egret.wxapp.WebGLRenderBuffer", [ "egret.sys.RenderBuffer" ]);
        var n = [];
    }(r.wxapp || (r.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(r) {
        var i = [ "source-over", "lighter", "destination-out" ], a = [], n = function() {
            ...
            return e.prototype.render = function(e, r, i, n) {
                ...
                if (h) for (var u = h.length, d = 0; d < u; d++) {
                    var l = h[d], p = void 0, f = void 0, g = void 0;
                    ...
                    if (l.$useTranslate) {
                        ...
                        (v = t.Matrix.create()).a = y.a, v.b = y.b, v.c = y.c, v.d = y.d, v.tx = y.tx, v.ty = y.ty, 
                        r.transform(x.a, x.b, x.c, x.d, p, f), p = -l.$anchorOffsetX, f = -l.$anchorOffsetY;
                    } else p = i + l.$x - l.$anchorOffsetX, f = a + l.$y - l.$anchorOffsetY;
                    switch (l.$renderMode) {
                      case 1:
                        break;

                      case 2:
                        s += this.drawWithFilter(l, r, p, f);
                        break;

                      case 3:
                        s += this.drawWithClip(l, r, p, f);
                        break;

                      case 4:
                        s += this.drawWithScrollRect(l, r, p, f);
                        break;

                      default:
                        s += this.drawDisplayObject(l, r, p, f);
                    }
                ...
                if (!e.$children || 0 != e.$children.length || e.$renderNode && 0 != e.$renderNode.$getRenderCount()) {
                    ...
                    if (d.width <= 0 || d.height <= 0) return s;
                    if (!e.mask && 1 == h.length && ("colorTransform" == h[0].type || "custom" === h[0].type && 0 === h[0].padding)) {
                        var l = this.getRenderCount(e);
                        if (!e.$children || 1 == l) return u && r.context.setGlobalCompositeOperation(c), 
                    ...
                    if (p.context.pushBuffer(p), e.$mask ? s += this.drawWithClip(e, p, -d.x, -d.y) : e.$scrollRect || e.$maskRect ? s += this.drawWithScrollRect(e, p, -d.x, -d.y) : s += this.drawDisplayObject(e, p, -d.x, -d.y), 
                    p.context.popBuffer(), s > 0) {
                        u && r.context.setGlobalCompositeOperation(c), s++, r.$offsetX = n + d.x, r.$offsetY = o + d.y;
                        var f = t.Matrix.create(), g = r.globalMatrix;
                        f.a = g.a, f.b = g.b, f.c = g.c, f.d = g.d, f.tx = g.tx, f.ty = g.ty, r.useOffset(), 
                        r.context.drawTargetWidthFilters(h, p), g.a = f.a, g.b = f.b, g.c = f.c, g.d = f.d, 
                        g.tx = f.tx, g.ty = f.ty, t.Matrix.release(f), u && r.context.setGlobalCompositeOperation("source-over");
                    }
                    return a.push(p), s;
                }
                ...
                if (d || e.$children && 0 != e.$children.length) {
                    var p = e.$getOriginalBounds(), f = this.createRenderBuffer(p.width, p.height);
                    if (f.context.pushBuffer(f), c += this.drawDisplayObject(e, f, -p.x, -p.y), d) {
                        var g = this.createRenderBuffer(p.width, p.height);
                        g.context.pushBuffer(g);
                        var v = t.Matrix.create();
                        v.copyFrom(d.$getConcatenatedMatrix()), d.$getConcatenatedMatrixAt(e, v), v.translate(-p.x, -p.y), 
                        g.setTransform(v.a, v.b, v.c, v.d, v.tx, v.ty), t.Matrix.release(v), c += this.drawDisplayObject(d, g, 0, 0), 
                        g.context.popBuffer(), f.context.setGlobalCompositeOperation("destination-in"), 
                        f.setTransform(1, 0, 0, -1, 0, g.height), f.globalAlpha = 1;
                        var x = g.rootRenderTarget.width, y = g.rootRenderTarget.height;
                        f.context.drawTexture(g.rootRenderTarget.texture, 0, 0, x, y, 0, 0, x, y, x, y), 
                        f.setTransform(1, 0, 0, 1, 0, 0), f.context.setGlobalCompositeOperation("source-over"), 
                        a.push(g);
                    }
                    if (f.context.setGlobalCompositeOperation("source-over"), f.context.popBuffer(), 
                    c > 0) {
                        c++, h && r.context.setGlobalCompositeOperation(s), u && r.context.pushMask(u.x + n, u.y + o, u.width, u.height), 
                        r.globalAlpha = 1;
                        var m = t.Matrix.create(), w = r.globalMatrix;
                        m.a = w.a, m.b = w.b, m.c = w.c, m.d = w.d, m.tx = w.tx, m.ty = w.ty, w.append(1, 0, 0, -1, n + p.x, o + p.y + f.height);
                        var b = f.rootRenderTarget.width, T = f.rootRenderTarget.height;
                        r.context.drawTexture(f.rootRenderTarget.texture, 0, 0, b, T, 0, 0, b, T, b, T), 
                        u && f.context.popMask(), h && r.context.setGlobalCompositeOperation("source-over");
                        var E = r.globalMatrix;
                        E.a = m.a, E.b = m.b, E.c = m.c, E.d = m.d, E.tx = m.tx, E.ty = m.ty, t.Matrix.release(m);
                    }
                    return a.push(f), c;
                }
                ...
                if (t.$hasScissor || 0 != o.b || 0 != o.c) t.context.pushMask(n.x + r, n.y + i, n.width, n.height); else {
                    var h = o.a, u = o.d, d = o.tx, l = o.ty, p = n.x + r, f = n.y + i, g = p + n.width, v = f + n.height, x = void 0, y = void 0, m = void 0, w = void 0;
                    if (1 == h && 1 == u) x = p + d, y = f + l, m = g + d, w = v + l; else {
                        var b = h * p + d, T = u * f + l, E = h * g + d, C = u * f + l, L = h * g + d, S = u * v + l, R = h * p + d, A = u * v + l, O = 0;
                        b > E && (O = b, b = E, E = O), L > R && (O = L, L = R, R = O), x = b < L ? b : L, 
                        m = E > R ? E : R, T > C && (O = T, T = C, C = O), S > A && (O = S, S = A, A = O), 
                        y = T < S ? T : S, w = C > A ? C : A;
                    }
                    s.enableScissor(x, -w + t.height, m - x, w - y), c = !0;
                }
                ...
                var a = e.image;
                if (a) {
                    var n, o, s, c = e.drawData, h = c.length, u = 0, d = e.matrix, l = e.blendMode, p = e.alpha;
                    if (d) {
                        n = t.Matrix.create();
                        var f = r.globalMatrix;
                        n.a = f.a, n.b = f.b, n.c = f.c, n.d = f.d, n.tx = f.tx, n.ty = f.ty, o = r.$offsetX, 
                        s = r.$offsetY, r.useOffset(), r.transform(d.a, d.b, d.c, d.d, d.tx, d.ty);
                    }
                    l && r.context.setGlobalCompositeOperation(i[l]);
                    var g;
                    if (p == p && (g = r.globalAlpha, r.globalAlpha *= p), e.filter) {
                    ...
                    if (l && r.context.setGlobalCompositeOperation("source-over"), p == p && (r.globalAlpha = g), 
                    d) {
                ...
                var a, n, o, s = e.image, c = e.drawData, h = c.length, u = 0, d = e.matrix, l = e.blendMode, p = e.alpha;
                if (d) {
                    a = t.Matrix.create();
                    var f = r.globalMatrix;
                    a.a = f.a, a.b = f.b, a.c = f.c, a.d = f.d, a.tx = f.tx, a.ty = f.ty, n = r.$offsetX, 
                    o = r.$offsetY, r.useOffset(), r.transform(d.a, d.b, d.c, d.d, d.tx, d.ty);
                }
                l && r.context.setGlobalCompositeOperation(i[l]);
                var g;
                if (p == p && (g = r.globalAlpha, r.globalAlpha *= p), e.filter) {
                ...
                if (!(a <= 0 || n <= 0) && a && n && 0 != e.drawData.length) {
                    ...
                    e.dirtyRender = !0), this.canvasRenderBuffer && this.canvasRenderBuffer.context ? e.dirtyRender && this.canvasRenderBuffer.resize(a, n) : (this.canvasRenderer = new t.CanvasRenderer(), 
                    this.canvasRenderBuffer = new r.CanvasRenderBuffer(a, n)), this.canvasRenderBuffer.context) {
                        ...
                        e.dirtyRender) {
                            ...
                            this.canvasRenderer.renderText(e, this.canvasRenderBuffer.context);
                            var l = e.$texture;
                            l ? i.context.updateTexture(l, d) : (l = i.context.createTexture(d), e.$texture = l), 
                            e.$textureWidth = d.width, e.$textureHeight = d.height;
                        }
                        var p = e.$textureWidth, f = e.$textureHeight;
                        i.context.drawTexture(e.$texture, 0, 0, p, f, 0, 0, p / o, f / s, p, f), (h || u) && (e.dirtyRender && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, 0, 0), 
                ...
                if (!(n <= 0 || o <= 0) && n && o && 0 != e.drawData.length) {
                    ...
                    if (s *= h / n, c *= u / o, n = h, o = u, this.canvasRenderBuffer && this.canvasRenderBuffer.context ? (e.dirtyRender || a) && this.canvasRenderBuffer.resize(n, o) : (this.canvasRenderer = new t.CanvasRenderer(), 
                    this.canvasRenderBuffer = new r.CanvasRenderBuffer(n, o)), this.canvasRenderBuffer.context) {
                        ...
                        var d = this.canvasRenderBuffer.surface;
                        if (a) {
                            this.canvasRenderer.renderGraphics(e, this.canvasRenderBuffer.context, !0), t.WebGLUtils.deleteWebGLTexture(d);
                            var l = i.context.getWebGLTexture(d);
                            i.context.drawTexture(l, 0, 0, n, o, 0, 0, n, o, d.width, d.height);
                        } else {
                            e.dirtyRender && (this.canvasRenderer.renderGraphics(e, this.canvasRenderBuffer.context), 
                            (l = e.$texture) ? i.context.updateTexture(l, d) : (l = i.context.createTexture(d), 
                            e.$texture = l), e.$textureWidth = d.width, e.$textureHeight = d.height);
                            var p = e.$textureWidth, f = e.$textureHeight;
                            i.context.drawTexture(e.$texture, 0, 0, p, f, 0, 0, p / s, f / c, p, f);
                        }
                        (e.x || e.y) && ((e.dirtyRender || a) && this.canvasRenderBuffer.context.translate(e.x, e.y), 
        ...
        r.WebGLRenderer = n, e(n.prototype, "egret.wxapp.WebGLRenderer", [ "egret.sys.SystemRenderer" ]);
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(t) {
        var r;
        ...
        t.EgretWebGLAttribute = i, e(i.prototype, "egret.wxapp.EgretWebGLAttribute");
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(t) {
        function r(e, t, r) {
        ...
        t.EgretWebGLProgram = o, e(o.prototype, "egret.wxapp.EgretWebGLProgram");
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(t) {
        var r;
        ...
        t.EgretWebGLUniform = i, e(i.prototype, "egret.wxapp.EgretWebGLUniform");
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {})), function(t) {
    !function(t) {
        var r = function() {
        ...
        t.EgretShaderLib = r, e(r.prototype, "egret.wxapp.EgretShaderLib");
    }(t.wxapp || (t.wxapp = {}));
}(egret || (egret = {}));