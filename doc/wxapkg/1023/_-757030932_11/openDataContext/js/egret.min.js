...
!function(t) {
    ...
    var n = function(e) {
        ...
        return i(n, e), n.prototype.createNativeDisplayObject = function() {
            ...
            set: function(e) {
                var i = this;
                return i.$filters || e ? (e && e.length ? (e = e.concat(), i.$filters = e, t.nativeRender && i.$nativeDisplayObject.setFilters(e)) : (i.$filters = e, 
                t.nativeRender && i.$nativeDisplayObject.setFilters(null)), void (t.nativeRender || i.$updateRenderMode())) : (i.$filters = e, 
                void (t.nativeRender ? i.$nativeDisplayObject.setFilters(null) : i.$updateRenderMode()));
            },
            enumerable: !0,
            configurable: !0
...
!function(t) {
    ...
    var n = function(e) {
        ...
        return i(n, e), n.prototype.$setTarget = function(e) {
        ...
        }, n.prototype.curveTo = function(e, i, r, n) {
            e = +e || 0, i = +i || 0, r = +r || 0, n = +n || 0, t.nativeRender && this.$targetDisplay.$nativeDisplayObject.setCurveTo(e, i, r, n);
            var a = this.fillPath, o = this.strokePath;
            a && a.curveTo(e, i, r, n), o && o.curveTo(e, i, r, n), this.extendBoundsByPoint(e, i), 
            this.extendBoundsByPoint(r, n), this.updatePosition(r, n), this.dirty();
        }, n.prototype.cubicCurveTo = function(e, i, r, n, a, o) {
            e = +e || 0, i = +i || 0, r = +r || 0, n = +n || 0, a = +a || 0, o = +o || 0, t.nativeRender && this.$targetDisplay.$nativeDisplayObject.setCubicCurveTo(e, i, r, n, a, o);
            var s = this.fillPath, h = this.strokePath;
            s && s.cubicCurveTo(e, i, r, n, a, o), h && h.cubicCurveTo(e, i, r, n, a, o), this.extendBoundsByPoint(e, i), 
            this.extendBoundsByPoint(r, n), this.extendBoundsByPoint(a, o), this.updatePosition(a, o), 
            this.dirty();
        }, n.prototype.drawArc = function(e, i, n, a, o, s) {
            if (!(0 > n || a === o)) {
    ...
    t.Graphics = n, e(n.prototype, "egret.Graphics");
}(p || (p = {}));
    ...
    !function(r) {
        var n = function(e) {
            ...
            return i(r, e), r.prototype.calculateStageSize = function(e, i, r, n, a) {
                ...
                return h % 2 != 0 && (h += 1), c % 2 != 0 && (c += 1), o % 2 != 0 && (o += 1), s % 2 != 0 && (s += 1), 
                {
                    stageWidth: h,
                    stageHeight: c,
                    displayWidth: o,
        ...
        var n = function(e) {
            ...
            return i(r, e), r.prototype.drawImage = function(t, e, i, r, n, a, o, s) {
                ...
                if ((x + R) * t.$TextureScaleFactor > p || (T + _) * t.$TextureScaleFactor > d) e.drawImage(n, a, o, s, h, c, p, d); else {
                    var j = h, A = j + b, B = j + (p - M), k = p - b - M, L = c, I = L + m, H = L + d - N, X = d - m - N;
                    ...
                    _ > 0 && (x > 0 && e.drawImage(w, C, x, _, j, H, b, N), D > 0 && e.drawImage(E, C, D, _, A, H, k, N), 
                    R > 0 && e.drawImage(S, C, R, _, B, H, M, N));
                }
    ...
    var r = function(e) {
        ...
        return i(r, e), r.prototype.drawToTexture = function(e, i, r) {
            ...
            if (s.resize(a, o), this.$bitmapData.width = a, this.$bitmapData.height = o, t.nativeRender) {
                ...
                d.identity(), i && d.translate(-i.x, -i.y), d.scale(r, r), t.sys.systemRenderer.render(e, s, d, !0), 
                t.Matrix.release(d);
            }
...
!function(i) {
    ...
    function g(t, e, i, r, n, a, s, h, c, l, u, p) {
        ...
        for (var f, $, g = r[3], v = 0, b = 0, m = h * Math.cos(s), x = h * Math.sin(s), T = 3.141592653589793, D = n / 7, O = a / 7, E = 0; e > E; E++) for (var S = 0; i > S; S++) {
            ...
            N = Math.max(N, 1e-4);
            var L = F / P * c * g * (1 - l) * Math.max(Math.min(p, u), 1 - N), I = (P - F) / P * c * g * l * N, H = I / (I + (N = Math.max(N * u * (1 - p), 1e-4))), X = y(C, r[0], H), U = y(_, r[1], H), Y = y(M, r[2], H), W = L / (I + N + L), G = y(X, r[0], W), z = y(U, r[1], W), V = y(Y, r[2], W), q = Math.min(N + L + I, 1);
    ...
    var v = [ "source-over", "lighter", "destination-out" ], b = "source-over", m = "#000000", x = {
        ...
        return t.prototype.render = function(t, e, r, n) {
            ...
            if (c && (!c.$children || 0 == c.$children.length) && u && 3 == u.type && 1 == u.drawData.length && 1 == u.drawData[0].type && 1 == u.drawData[0].fillAlpha) {
                ...
                var p = this.drawDisplayObject(c, e, r, n);
                ...
                e.clip()), p += this.drawDisplayObject(t, e, r, n), e.restore(), p;
            }
            var d = t.$getOriginalBounds(), f = d.x, $ = d.y, y = d.width, g = d.height, m = this.createRenderBuffer(y, g), x = m.context;
            if (!x) return o += this.drawDisplayObject(t, e, r, n);
            if (o += this.drawDisplayObject(t, x, -f, -$), c) {
                var D = i.Matrix.create();
                if (D.copyFrom(c.$getConcatenatedMatrix()), c.$getConcatenatedMatrixAt(t, D), D.translate(-f, -$), 
                u && 1 == u.$getRenderCount() || c.$displayList) x.globalCompositeOperation = "destination-in", 
                x.save(), x.setTransform(D.a, D.b, D.c, D.d, D.tx, D.ty), o += this.drawDisplayObject(c, x, 0, 0), 
                x.restore(); else {
                    var O = this.createRenderBuffer(y, g), w = O.context;
                    w.setTransform(D.a, D.b, D.c, D.d, D.tx, D.ty), o += this.drawDisplayObject(c, w, 0, 0), 
                    x.globalCompositeOperation = "destination-in", x.drawImage(O.surface, 0, 0), T.push(O);
                }
                i.Matrix.release(D);
            }
            return o > 0 && (o++, s && (e.globalCompositeOperation = a), h && (e.save(), e.beginPath(), 
            e.rect(h.x + r, h.y + n, h.width, h.height), e.clip()), e.drawImage(m.surface, r + f, n + $), 
            h && e.restore(), s && (e.globalCompositeOperation = b)), T.push(m), o;
...
!function(t) {
    ...
    var i = function() {
        ...
        e.engineVersion = "5.2.1", e.renderMode = "Unknown", e.boundingClientWidth = 0, 
...
!function(t) {
    ...
    var n = new RegExp("(?=[\\u00BF-\\u1FFF\\u2C00-\\uD7FF]|\\b|\\s)(?![。，！、》…）)}”】\\.\\,\\!\\?\\]\\:])"), a = function(e) {
        ...
        return i(a, e), a.prototype.createNativeDisplayObject = function() {
            ...
            get: function() {
                return this.$getLinesArr(), t.nativeRender ? egret_native.nrGetTextFieldWidth(this.$nativeDisplayObject.id) : this.$TextField[5];
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(a.prototype, "textHeight", {
            get: function() {
                return this.$getLinesArr(), t.nativeRender ? egret_native.nrGetTextFieldHeight(this.$nativeDisplayObject.id) : t.TextFieldUtils.$getTextHeight(this);
            },
            enumerable: !0,
            configurable: !0
